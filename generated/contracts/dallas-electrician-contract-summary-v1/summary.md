...
- Kind: `imported`
- Normalized counts: `244` properties, `244` permits, `500` inspections, `5` contractors, `3` rule documents, `752` source records
- Fixture counts: `244` sequences, `5` pattern slices, `5` repeated slices, max permit support `232`
- Eval counts: `511` tasks, `250` reviewed label rows, `6` repeated next-action groups, `506` dev, `5` test
