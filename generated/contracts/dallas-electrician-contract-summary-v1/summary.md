...
- Kind: `imported`
- Normalized counts: `168` properties, `168` permits, `348` inspections, `5` contractors, `3` rule documents, `524` source records
- Fixture counts: `168` sequences, `5` pattern slices, `5` repeated slices, max permit support `156`
- Eval counts: `359` tasks, `174` reviewed label rows, `6` repeated next-action groups, `354` dev, `5` test
