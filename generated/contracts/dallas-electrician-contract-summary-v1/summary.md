...
- Kind: `imported`
- Normalized counts: `486` properties, `486` permits, `984` inspections, `5` contractors, `3` rule documents, `1478` source records
- Fixture counts: `486` sequences, `5` pattern slices, `5` repeated slices, max permit support `474`
- Eval counts: `995` tasks, `492` reviewed label rows, `6` repeated next-action groups, `990` dev, `5` test
