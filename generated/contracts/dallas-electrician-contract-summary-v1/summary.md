...
- Kind: `imported`
- Normalized counts: `107` properties, `107` permits, `226` inspections, `5` contractors, `3` rule documents, `341` source records
- Fixture counts: `107` sequences, `5` pattern slices, `5` repeated slices, max permit support `95`
- Eval counts: `237` tasks, `113` reviewed label rows, `6` repeated next-action groups, `232` dev, `5` test
