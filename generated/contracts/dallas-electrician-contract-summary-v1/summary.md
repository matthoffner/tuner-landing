...
- Kind: `imported`
- Normalized counts: `190` properties, `190` permits, `392` inspections, `5` contractors, `3` rule documents, `590` source records
- Fixture counts: `190` sequences, `5` pattern slices, `5` repeated slices, max permit support `178`
- Eval counts: `403` tasks, `196` reviewed label rows, `6` repeated next-action groups, `398` dev, `5` test
