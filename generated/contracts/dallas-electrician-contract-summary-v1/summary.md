...
- Kind: `imported`
- Normalized counts: `477` properties, `477` permits, `966` inspections, `5` contractors, `3` rule documents, `1451` source records
- Fixture counts: `477` sequences, `5` pattern slices, `5` repeated slices, max permit support `465`
- Eval counts: `977` tasks, `483` reviewed label rows, `6` repeated next-action groups, `972` dev, `5` test
