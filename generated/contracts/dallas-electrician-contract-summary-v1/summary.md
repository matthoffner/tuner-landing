...
- Kind: `imported`
- Normalized counts: `271` properties, `271` permits, `554` inspections, `5` contractors, `3` rule documents, `833` source records
- Fixture counts: `271` sequences, `5` pattern slices, `5` repeated slices, max permit support `259`
- Eval counts: `565` tasks, `277` reviewed label rows, `6` repeated next-action groups, `560` dev, `5` test
