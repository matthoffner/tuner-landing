...
- Kind: `imported`
- Normalized counts: `28` properties, `28` permits, `68` inspections, `5` contractors, `3` rule documents, `104` source records
- Fixture counts: `28` sequences, `5` pattern slices, `5` repeated slices, max permit support `16`
- Eval counts: `79` tasks, `34` reviewed label rows, `6` repeated next-action groups, `74` dev, `5` test
