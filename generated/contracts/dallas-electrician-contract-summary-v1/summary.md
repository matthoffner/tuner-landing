...
- Kind: `imported`
- Normalized counts: `341` properties, `341` permits, `694` inspections, `5` contractors, `3` rule documents, `1043` source records
- Fixture counts: `341` sequences, `5` pattern slices, `5` repeated slices, max permit support `329`
- Eval counts: `705` tasks, `347` reviewed label rows, `6` repeated next-action groups, `700` dev, `5` test
