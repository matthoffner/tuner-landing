...
- Kind: `imported`
- Normalized counts: `426` properties, `426` permits, `864` inspections, `5` contractors, `3` rule documents, `1298` source records
- Fixture counts: `426` sequences, `5` pattern slices, `5` repeated slices, max permit support `414`
- Eval counts: `875` tasks, `432` reviewed label rows, `6` repeated next-action groups, `870` dev, `5` test
