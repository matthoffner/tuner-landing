...
- Kind: `imported`
- Normalized counts: `139` properties, `139` permits, `290` inspections, `5` contractors, `3` rule documents, `437` source records
- Fixture counts: `139` sequences, `5` pattern slices, `5` repeated slices, max permit support `127`
- Eval counts: `301` tasks, `145` reviewed label rows, `6` repeated next-action groups, `296` dev, `5` test
