...
- Kind: `imported`
- Normalized counts: `269` properties, `269` permits, `550` inspections, `5` contractors, `3` rule documents, `827` source records
- Fixture counts: `269` sequences, `5` pattern slices, `5` repeated slices, max permit support `257`
- Eval counts: `561` tasks, `275` reviewed label rows, `6` repeated next-action groups, `556` dev, `5` test
