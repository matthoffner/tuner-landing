...
- Kind: `imported`
- Normalized counts: `265` properties, `265` permits, `542` inspections, `5` contractors, `3` rule documents, `815` source records
- Fixture counts: `265` sequences, `5` pattern slices, `5` repeated slices, max permit support `253`
- Eval counts: `553` tasks, `271` reviewed label rows, `6` repeated next-action groups, `548` dev, `5` test
