...
- Kind: `imported`
- Normalized counts: `388` properties, `388` permits, `788` inspections, `5` contractors, `3` rule documents, `1184` source records
- Fixture counts: `388` sequences, `5` pattern slices, `5` repeated slices, max permit support `376`
- Eval counts: `799` tasks, `394` reviewed label rows, `6` repeated next-action groups, `794` dev, `5` test
