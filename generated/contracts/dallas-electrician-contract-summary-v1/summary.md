...
- Kind: `imported`
- Normalized counts: `40` properties, `40` permits, `92` inspections, `5` contractors, `3` rule documents, `140` source records
- Fixture counts: `40` sequences, `5` pattern slices, `5` repeated slices, max permit support `28`
- Eval counts: `103` tasks, `46` reviewed label rows, `6` repeated next-action groups, `98` dev, `5` test
