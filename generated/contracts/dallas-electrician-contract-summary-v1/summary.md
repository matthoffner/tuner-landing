...
- Kind: `imported`
- Normalized counts: `210` properties, `210` permits, `432` inspections, `5` contractors, `3` rule documents, `650` source records
- Fixture counts: `210` sequences, `5` pattern slices, `5` repeated slices, max permit support `198`
- Eval counts: `443` tasks, `216` reviewed label rows, `6` repeated next-action groups, `438` dev, `5` test
