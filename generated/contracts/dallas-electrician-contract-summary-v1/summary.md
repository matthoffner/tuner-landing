...
- Kind: `imported`
- Normalized counts: `433` properties, `433` permits, `878` inspections, `5` contractors, `3` rule documents, `1319` source records
- Fixture counts: `433` sequences, `5` pattern slices, `5` repeated slices, max permit support `421`
- Eval counts: `889` tasks, `439` reviewed label rows, `6` repeated next-action groups, `884` dev, `5` test
