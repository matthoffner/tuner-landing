...
- Kind: `imported`
- Normalized counts: `208` properties, `208` permits, `428` inspections, `5` contractors, `3` rule documents, `644` source records
- Fixture counts: `208` sequences, `5` pattern slices, `5` repeated slices, max permit support `196`
- Eval counts: `439` tasks, `214` reviewed label rows, `6` repeated next-action groups, `434` dev, `5` test
