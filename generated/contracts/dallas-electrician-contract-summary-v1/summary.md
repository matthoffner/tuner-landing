...
- Kind: `imported`
- Normalized counts: `526` properties, `526` permits, `1064` inspections, `5` contractors, `3` rule documents, `1598` source records
- Fixture counts: `526` sequences, `5` pattern slices, `5` repeated slices, max permit support `514`
- Eval counts: `1075` tasks, `532` reviewed label rows, `6` repeated next-action groups, `1070` dev, `5` test
