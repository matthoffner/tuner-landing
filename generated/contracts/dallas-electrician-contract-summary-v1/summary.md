...
- Kind: `imported`
- Normalized counts: `187` properties, `187` permits, `386` inspections, `5` contractors, `3` rule documents, `581` source records
- Fixture counts: `187` sequences, `5` pattern slices, `5` repeated slices, max permit support `175`
- Eval counts: `397` tasks, `193` reviewed label rows, `6` repeated next-action groups, `392` dev, `5` test
