...
- Kind: `imported`
- Normalized counts: `403` properties, `403` permits, `818` inspections, `5` contractors, `3` rule documents, `1229` source records
- Fixture counts: `403` sequences, `5` pattern slices, `5` repeated slices, max permit support `391`
- Eval counts: `829` tasks, `409` reviewed label rows, `6` repeated next-action groups, `824` dev, `5` test
