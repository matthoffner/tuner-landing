...
- Kind: `imported`
- Normalized counts: `425` properties, `425` permits, `862` inspections, `5` contractors, `3` rule documents, `1295` source records
- Fixture counts: `425` sequences, `5` pattern slices, `5` repeated slices, max permit support `413`
- Eval counts: `873` tasks, `431` reviewed label rows, `6` repeated next-action groups, `868` dev, `5` test
