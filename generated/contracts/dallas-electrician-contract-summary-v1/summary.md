...
- Kind: `imported`
- Normalized counts: `286` properties, `286` permits, `584` inspections, `5` contractors, `3` rule documents, `878` source records
- Fixture counts: `286` sequences, `5` pattern slices, `5` repeated slices, max permit support `274`
- Eval counts: `595` tasks, `292` reviewed label rows, `6` repeated next-action groups, `590` dev, `5` test
