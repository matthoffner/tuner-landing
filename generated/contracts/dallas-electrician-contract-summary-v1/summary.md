...
- Kind: `imported`
- Normalized counts: `488` properties, `488` permits, `988` inspections, `5` contractors, `3` rule documents, `1484` source records
- Fixture counts: `488` sequences, `5` pattern slices, `5` repeated slices, max permit support `476`
- Eval counts: `999` tasks, `494` reviewed label rows, `6` repeated next-action groups, `994` dev, `5` test
