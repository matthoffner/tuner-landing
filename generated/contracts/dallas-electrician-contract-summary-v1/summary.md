...
- Kind: `imported`
- Normalized counts: `281` properties, `281` permits, `574` inspections, `5` contractors, `3` rule documents, `863` source records
- Fixture counts: `281` sequences, `5` pattern slices, `5` repeated slices, max permit support `269`
- Eval counts: `585` tasks, `287` reviewed label rows, `6` repeated next-action groups, `580` dev, `5` test
