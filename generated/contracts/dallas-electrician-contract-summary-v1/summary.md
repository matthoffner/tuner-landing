...
- Kind: `imported`
- Normalized counts: `416` properties, `416` permits, `844` inspections, `5` contractors, `3` rule documents, `1268` source records
- Fixture counts: `416` sequences, `5` pattern slices, `5` repeated slices, max permit support `404`
- Eval counts: `855` tasks, `422` reviewed label rows, `6` repeated next-action groups, `850` dev, `5` test
