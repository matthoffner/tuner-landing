...
- Kind: `imported`
- Normalized counts: `534` properties, `534` permits, `1080` inspections, `5` contractors, `3` rule documents, `1622` source records
- Fixture counts: `534` sequences, `5` pattern slices, `5` repeated slices, max permit support `522`
- Eval counts: `1091` tasks, `540` reviewed label rows, `6` repeated next-action groups, `1086` dev, `5` test
