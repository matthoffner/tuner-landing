...
- Kind: `imported`
- Normalized counts: `376` properties, `376` permits, `764` inspections, `5` contractors, `3` rule documents, `1148` source records
- Fixture counts: `376` sequences, `5` pattern slices, `5` repeated slices, max permit support `364`
- Eval counts: `775` tasks, `382` reviewed label rows, `6` repeated next-action groups, `770` dev, `5` test
