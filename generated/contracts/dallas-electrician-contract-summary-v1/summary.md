...
- Kind: `imported`
- Normalized counts: `280` properties, `280` permits, `572` inspections, `5` contractors, `3` rule documents, `860` source records
- Fixture counts: `280` sequences, `5` pattern slices, `5` repeated slices, max permit support `268`
- Eval counts: `583` tasks, `286` reviewed label rows, `6` repeated next-action groups, `578` dev, `5` test
