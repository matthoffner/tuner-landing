...
- Kind: `imported`
- Normalized counts: `470` properties, `470` permits, `952` inspections, `5` contractors, `3` rule documents, `1430` source records
- Fixture counts: `470` sequences, `5` pattern slices, `5` repeated slices, max permit support `458`
- Eval counts: `963` tasks, `476` reviewed label rows, `6` repeated next-action groups, `958` dev, `5` test
