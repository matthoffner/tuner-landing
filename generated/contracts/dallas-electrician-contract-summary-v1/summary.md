...
- Kind: `imported`
- Normalized counts: `391` properties, `391` permits, `794` inspections, `5` contractors, `3` rule documents, `1193` source records
- Fixture counts: `391` sequences, `5` pattern slices, `5` repeated slices, max permit support `379`
- Eval counts: `805` tasks, `397` reviewed label rows, `6` repeated next-action groups, `800` dev, `5` test
