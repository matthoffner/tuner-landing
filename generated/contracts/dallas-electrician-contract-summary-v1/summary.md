...
- Kind: `imported`
- Normalized counts: `457` properties, `457` permits, `926` inspections, `5` contractors, `3` rule documents, `1391` source records
- Fixture counts: `457` sequences, `5` pattern slices, `5` repeated slices, max permit support `445`
- Eval counts: `937` tasks, `463` reviewed label rows, `6` repeated next-action groups, `932` dev, `5` test
