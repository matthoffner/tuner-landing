...
- Kind: `imported`
- Normalized counts: `467` properties, `467` permits, `946` inspections, `5` contractors, `3` rule documents, `1421` source records
- Fixture counts: `467` sequences, `5` pattern slices, `5` repeated slices, max permit support `455`
- Eval counts: `957` tasks, `473` reviewed label rows, `6` repeated next-action groups, `952` dev, `5` test
