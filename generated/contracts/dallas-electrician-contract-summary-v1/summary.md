...
- Kind: `imported`
- Normalized counts: `468` properties, `468` permits, `948` inspections, `5` contractors, `3` rule documents, `1424` source records
- Fixture counts: `468` sequences, `5` pattern slices, `5` repeated slices, max permit support `456`
- Eval counts: `959` tasks, `474` reviewed label rows, `6` repeated next-action groups, `954` dev, `5` test
