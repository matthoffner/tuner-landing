...
- Kind: `imported`
- Normalized counts: `293` properties, `293` permits, `598` inspections, `5` contractors, `3` rule documents, `899` source records
- Fixture counts: `293` sequences, `5` pattern slices, `5` repeated slices, max permit support `281`
- Eval counts: `609` tasks, `299` reviewed label rows, `6` repeated next-action groups, `604` dev, `5` test
