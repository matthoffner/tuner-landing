...
- Kind: `imported`
- Normalized counts: `258` properties, `258` permits, `528` inspections, `5` contractors, `3` rule documents, `794` source records
- Fixture counts: `258` sequences, `5` pattern slices, `5` repeated slices, max permit support `246`
- Eval counts: `539` tasks, `264` reviewed label rows, `6` repeated next-action groups, `534` dev, `5` test
