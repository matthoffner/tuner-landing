...
- Kind: `imported`
- Normalized counts: `414` properties, `414` permits, `840` inspections, `5` contractors, `3` rule documents, `1262` source records
- Fixture counts: `414` sequences, `5` pattern slices, `5` repeated slices, max permit support `402`
- Eval counts: `851` tasks, `420` reviewed label rows, `6` repeated next-action groups, `846` dev, `5` test
