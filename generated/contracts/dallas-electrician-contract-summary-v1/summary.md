...
- Kind: `imported`
- Normalized counts: `465` properties, `465` permits, `942` inspections, `5` contractors, `3` rule documents, `1415` source records
- Fixture counts: `465` sequences, `5` pattern slices, `5` repeated slices, max permit support `453`
- Eval counts: `953` tasks, `471` reviewed label rows, `6` repeated next-action groups, `948` dev, `5` test
