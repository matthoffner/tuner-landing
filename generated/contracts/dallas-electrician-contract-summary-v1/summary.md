...
- Kind: `imported`
- Normalized counts: `102` properties, `102` permits, `216` inspections, `5` contractors, `3` rule documents, `326` source records
- Fixture counts: `102` sequences, `5` pattern slices, `5` repeated slices, max permit support `90`
- Eval counts: `227` tasks, `108` reviewed label rows, `6` repeated next-action groups, `222` dev, `5` test
