...
- Kind: `imported`
- Normalized counts: `202` properties, `202` permits, `416` inspections, `5` contractors, `3` rule documents, `626` source records
- Fixture counts: `202` sequences, `5` pattern slices, `5` repeated slices, max permit support `190`
- Eval counts: `427` tasks, `208` reviewed label rows, `6` repeated next-action groups, `422` dev, `5` test
