...
- Kind: `imported`
- Normalized counts: `452` properties, `452` permits, `916` inspections, `5` contractors, `3` rule documents, `1376` source records
- Fixture counts: `452` sequences, `5` pattern slices, `5` repeated slices, max permit support `440`
- Eval counts: `927` tasks, `458` reviewed label rows, `6` repeated next-action groups, `922` dev, `5` test
