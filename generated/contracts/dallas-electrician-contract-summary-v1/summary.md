...
- Kind: `imported`
- Normalized counts: `518` properties, `518` permits, `1048` inspections, `5` contractors, `3` rule documents, `1574` source records
- Fixture counts: `518` sequences, `5` pattern slices, `5` repeated slices, max permit support `506`
- Eval counts: `1059` tasks, `524` reviewed label rows, `6` repeated next-action groups, `1054` dev, `5` test
