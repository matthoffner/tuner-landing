...
- Kind: `imported`
- Normalized counts: `331` properties, `331` permits, `674` inspections, `5` contractors, `3` rule documents, `1013` source records
- Fixture counts: `331` sequences, `5` pattern slices, `5` repeated slices, max permit support `319`
- Eval counts: `685` tasks, `337` reviewed label rows, `6` repeated next-action groups, `680` dev, `5` test
