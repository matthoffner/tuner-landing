...
- Kind: `imported`
- Normalized counts: `528` properties, `528` permits, `1068` inspections, `5` contractors, `3` rule documents, `1604` source records
- Fixture counts: `528` sequences, `5` pattern slices, `5` repeated slices, max permit support `516`
- Eval counts: `1079` tasks, `534` reviewed label rows, `6` repeated next-action groups, `1074` dev, `5` test
