...
- Kind: `imported`
- Normalized counts: `322` properties, `322` permits, `656` inspections, `5` contractors, `3` rule documents, `986` source records
- Fixture counts: `322` sequences, `5` pattern slices, `5` repeated slices, max permit support `310`
- Eval counts: `667` tasks, `328` reviewed label rows, `6` repeated next-action groups, `662` dev, `5` test
