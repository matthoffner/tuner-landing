...
- Kind: `imported`
- Normalized counts: `270` properties, `270` permits, `552` inspections, `5` contractors, `3` rule documents, `830` source records
- Fixture counts: `270` sequences, `5` pattern slices, `5` repeated slices, max permit support `258`
- Eval counts: `563` tasks, `276` reviewed label rows, `6` repeated next-action groups, `558` dev, `5` test
