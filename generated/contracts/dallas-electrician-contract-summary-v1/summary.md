...
- Kind: `imported`
- Normalized counts: `318` properties, `318` permits, `648` inspections, `5` contractors, `3` rule documents, `974` source records
- Fixture counts: `318` sequences, `5` pattern slices, `5` repeated slices, max permit support `306`
- Eval counts: `659` tasks, `324` reviewed label rows, `6` repeated next-action groups, `654` dev, `5` test
