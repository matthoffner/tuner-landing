...
- Kind: `imported`
- Normalized counts: `150` properties, `150` permits, `312` inspections, `5` contractors, `3` rule documents, `470` source records
- Fixture counts: `150` sequences, `5` pattern slices, `5` repeated slices, max permit support `138`
- Eval counts: `323` tasks, `156` reviewed label rows, `6` repeated next-action groups, `318` dev, `5` test
