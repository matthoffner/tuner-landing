...
- Kind: `imported`
- Normalized counts: `20` properties, `20` permits, `52` inspections, `5` contractors, `3` rule documents, `80` source records
- Fixture counts: `20` sequences, `5` pattern slices, `5` repeated slices, max permit support `8`
- Eval counts: `63` tasks, `26` reviewed label rows, `6` repeated next-action groups, `58` dev, `5` test
