...
- Kind: `imported`
- Normalized counts: `384` properties, `384` permits, `780` inspections, `5` contractors, `3` rule documents, `1172` source records
- Fixture counts: `384` sequences, `5` pattern slices, `5` repeated slices, max permit support `372`
- Eval counts: `791` tasks, `390` reviewed label rows, `6` repeated next-action groups, `786` dev, `5` test
