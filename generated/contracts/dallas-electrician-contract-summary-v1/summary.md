...
- Kind: `imported`
- Normalized counts: `367` properties, `367` permits, `746` inspections, `5` contractors, `3` rule documents, `1121` source records
- Fixture counts: `367` sequences, `5` pattern slices, `5` repeated slices, max permit support `355`
- Eval counts: `757` tasks, `373` reviewed label rows, `6` repeated next-action groups, `752` dev, `5` test
