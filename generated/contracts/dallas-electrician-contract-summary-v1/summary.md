...
- Kind: `imported`
- Normalized counts: `466` properties, `466` permits, `944` inspections, `5` contractors, `3` rule documents, `1418` source records
- Fixture counts: `466` sequences, `5` pattern slices, `5` repeated slices, max permit support `454`
- Eval counts: `955` tasks, `472` reviewed label rows, `6` repeated next-action groups, `950` dev, `5` test
