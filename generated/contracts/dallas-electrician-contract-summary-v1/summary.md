...
- Kind: `imported`
- Normalized counts: `287` properties, `287` permits, `586` inspections, `5` contractors, `3` rule documents, `881` source records
- Fixture counts: `287` sequences, `5` pattern slices, `5` repeated slices, max permit support `275`
- Eval counts: `597` tasks, `293` reviewed label rows, `6` repeated next-action groups, `592` dev, `5` test
