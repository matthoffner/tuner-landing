...
- Kind: `imported`
- Normalized counts: `229` properties, `229` permits, `470` inspections, `5` contractors, `3` rule documents, `707` source records
- Fixture counts: `229` sequences, `5` pattern slices, `5` repeated slices, max permit support `217`
- Eval counts: `481` tasks, `235` reviewed label rows, `6` repeated next-action groups, `476` dev, `5` test
