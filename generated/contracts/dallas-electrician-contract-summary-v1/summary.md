...
- Kind: `imported`
- Normalized counts: `186` properties, `186` permits, `384` inspections, `5` contractors, `3` rule documents, `578` source records
- Fixture counts: `186` sequences, `5` pattern slices, `5` repeated slices, max permit support `174`
- Eval counts: `395` tasks, `192` reviewed label rows, `6` repeated next-action groups, `390` dev, `5` test
