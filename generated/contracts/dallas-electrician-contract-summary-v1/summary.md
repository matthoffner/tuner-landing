...
- Kind: `imported`
- Normalized counts: `350` properties, `350` permits, `712` inspections, `5` contractors, `3` rule documents, `1070` source records
- Fixture counts: `350` sequences, `5` pattern slices, `5` repeated slices, max permit support `338`
- Eval counts: `723` tasks, `356` reviewed label rows, `6` repeated next-action groups, `718` dev, `5` test
