...
- Kind: `imported`
- Normalized counts: `377` properties, `377` permits, `766` inspections, `5` contractors, `3` rule documents, `1151` source records
- Fixture counts: `377` sequences, `5` pattern slices, `5` repeated slices, max permit support `365`
- Eval counts: `777` tasks, `383` reviewed label rows, `6` repeated next-action groups, `772` dev, `5` test
