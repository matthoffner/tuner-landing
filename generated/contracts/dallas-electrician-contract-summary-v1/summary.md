...
- Kind: `imported`
- Normalized counts: `516` properties, `516` permits, `1044` inspections, `5` contractors, `3` rule documents, `1568` source records
- Fixture counts: `516` sequences, `5` pattern slices, `5` repeated slices, max permit support `504`
- Eval counts: `1055` tasks, `522` reviewed label rows, `6` repeated next-action groups, `1050` dev, `5` test
