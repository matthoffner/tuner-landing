...
- Kind: `imported`
- Normalized counts: `82` properties, `82` permits, `176` inspections, `5` contractors, `3` rule documents, `266` source records
- Fixture counts: `82` sequences, `5` pattern slices, `5` repeated slices, max permit support `70`
- Eval counts: `187` tasks, `88` reviewed label rows, `6` repeated next-action groups, `182` dev, `5` test
