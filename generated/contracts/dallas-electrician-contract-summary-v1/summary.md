...
- Kind: `imported`
- Normalized counts: `221` properties, `221` permits, `454` inspections, `5` contractors, `3` rule documents, `683` source records
- Fixture counts: `221` sequences, `5` pattern slices, `5` repeated slices, max permit support `209`
- Eval counts: `465` tasks, `227` reviewed label rows, `6` repeated next-action groups, `460` dev, `5` test
