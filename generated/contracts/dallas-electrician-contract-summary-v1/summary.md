...
- Kind: `imported`
- Normalized counts: `112` properties, `112` permits, `236` inspections, `5` contractors, `3` rule documents, `356` source records
- Fixture counts: `112` sequences, `5` pattern slices, `5` repeated slices, max permit support `100`
- Eval counts: `247` tasks, `118` reviewed label rows, `6` repeated next-action groups, `242` dev, `5` test
