...
- Kind: `imported`
- Normalized counts: `91` properties, `91` permits, `194` inspections, `5` contractors, `3` rule documents, `293` source records
- Fixture counts: `91` sequences, `5` pattern slices, `5` repeated slices, max permit support `79`
- Eval counts: `205` tasks, `97` reviewed label rows, `6` repeated next-action groups, `200` dev, `5` test
