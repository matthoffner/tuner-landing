...
- Kind: `imported`
- Normalized counts: `400` properties, `400` permits, `812` inspections, `5` contractors, `3` rule documents, `1220` source records
- Fixture counts: `400` sequences, `5` pattern slices, `5` repeated slices, max permit support `388`
- Eval counts: `823` tasks, `406` reviewed label rows, `6` repeated next-action groups, `818` dev, `5` test
