...
- Kind: `imported`
- Normalized counts: `83` properties, `83` permits, `178` inspections, `5` contractors, `3` rule documents, `269` source records
- Fixture counts: `83` sequences, `5` pattern slices, `5` repeated slices, max permit support `71`
- Eval counts: `189` tasks, `89` reviewed label rows, `6` repeated next-action groups, `184` dev, `5` test
