...
- Kind: `imported`
- Normalized counts: `64` properties, `64` permits, `140` inspections, `5` contractors, `3` rule documents, `212` source records
- Fixture counts: `64` sequences, `5` pattern slices, `5` repeated slices, max permit support `52`
- Eval counts: `151` tasks, `70` reviewed label rows, `6` repeated next-action groups, `146` dev, `5` test
