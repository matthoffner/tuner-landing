...
- Kind: `imported`
- Normalized counts: `46` properties, `46` permits, `104` inspections, `5` contractors, `3` rule documents, `158` source records
- Fixture counts: `46` sequences, `5` pattern slices, `5` repeated slices, max permit support `34`
- Eval counts: `115` tasks, `52` reviewed label rows, `6` repeated next-action groups, `110` dev, `5` test
