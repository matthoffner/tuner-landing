...
- Kind: `imported`
- Normalized counts: `312` properties, `312` permits, `636` inspections, `5` contractors, `3` rule documents, `956` source records
- Fixture counts: `312` sequences, `5` pattern slices, `5` repeated slices, max permit support `300`
- Eval counts: `647` tasks, `318` reviewed label rows, `6` repeated next-action groups, `642` dev, `5` test
