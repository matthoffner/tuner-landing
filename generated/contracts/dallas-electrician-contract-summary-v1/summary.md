...
- Kind: `imported`
- Normalized counts: `445` properties, `445` permits, `902` inspections, `5` contractors, `3` rule documents, `1355` source records
- Fixture counts: `445` sequences, `5` pattern slices, `5` repeated slices, max permit support `433`
- Eval counts: `913` tasks, `451` reviewed label rows, `6` repeated next-action groups, `908` dev, `5` test
