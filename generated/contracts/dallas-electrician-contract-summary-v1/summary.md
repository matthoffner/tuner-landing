...
- Kind: `imported`
- Normalized counts: `451` properties, `451` permits, `914` inspections, `5` contractors, `3` rule documents, `1373` source records
- Fixture counts: `451` sequences, `5` pattern slices, `5` repeated slices, max permit support `439`
- Eval counts: `925` tasks, `457` reviewed label rows, `6` repeated next-action groups, `920` dev, `5` test
