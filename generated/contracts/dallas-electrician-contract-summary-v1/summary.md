...
- Kind: `imported`
- Normalized counts: `489` properties, `489` permits, `990` inspections, `5` contractors, `3` rule documents, `1487` source records
- Fixture counts: `489` sequences, `5` pattern slices, `5` repeated slices, max permit support `477`
- Eval counts: `1001` tasks, `495` reviewed label rows, `6` repeated next-action groups, `996` dev, `5` test
