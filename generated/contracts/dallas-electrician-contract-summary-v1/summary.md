...
- Kind: `imported`
- Normalized counts: `496` properties, `496` permits, `1004` inspections, `5` contractors, `3` rule documents, `1508` source records
- Fixture counts: `496` sequences, `5` pattern slices, `5` repeated slices, max permit support `484`
- Eval counts: `1015` tasks, `502` reviewed label rows, `6` repeated next-action groups, `1010` dev, `5` test
