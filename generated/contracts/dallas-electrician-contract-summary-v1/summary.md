...
- Kind: `imported`
- Normalized counts: `129` properties, `129` permits, `270` inspections, `5` contractors, `3` rule documents, `407` source records
- Fixture counts: `129` sequences, `5` pattern slices, `5` repeated slices, max permit support `117`
- Eval counts: `281` tasks, `135` reviewed label rows, `6` repeated next-action groups, `276` dev, `5` test
