...
- Kind: `imported`
- Normalized counts: `362` properties, `362` permits, `736` inspections, `5` contractors, `3` rule documents, `1106` source records
- Fixture counts: `362` sequences, `5` pattern slices, `5` repeated slices, max permit support `350`
- Eval counts: `747` tasks, `368` reviewed label rows, `6` repeated next-action groups, `742` dev, `5` test
