...
- Kind: `imported`
- Normalized counts: `458` properties, `458` permits, `928` inspections, `5` contractors, `3` rule documents, `1394` source records
- Fixture counts: `458` sequences, `5` pattern slices, `5` repeated slices, max permit support `446`
- Eval counts: `939` tasks, `464` reviewed label rows, `6` repeated next-action groups, `934` dev, `5` test
