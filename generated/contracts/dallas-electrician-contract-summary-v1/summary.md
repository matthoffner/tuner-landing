...
- Kind: `imported`
- Normalized counts: `117` properties, `117` permits, `246` inspections, `5` contractors, `3` rule documents, `371` source records
- Fixture counts: `117` sequences, `5` pattern slices, `5` repeated slices, max permit support `105`
- Eval counts: `257` tasks, `123` reviewed label rows, `6` repeated next-action groups, `252` dev, `5` test
