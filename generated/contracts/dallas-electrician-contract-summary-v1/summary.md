...
- Kind: `imported`
- Normalized counts: `49` properties, `49` permits, `110` inspections, `5` contractors, `3` rule documents, `167` source records
- Fixture counts: `49` sequences, `5` pattern slices, `5` repeated slices, max permit support `37`
- Eval counts: `121` tasks, `55` reviewed label rows, `6` repeated next-action groups, `116` dev, `5` test
