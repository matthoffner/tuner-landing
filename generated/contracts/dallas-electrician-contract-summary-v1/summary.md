...
- Kind: `imported`
- Normalized counts: `80` properties, `80` permits, `172` inspections, `5` contractors, `3` rule documents, `260` source records
- Fixture counts: `80` sequences, `5` pattern slices, `5` repeated slices, max permit support `68`
- Eval counts: `183` tasks, `86` reviewed label rows, `6` repeated next-action groups, `178` dev, `5` test
