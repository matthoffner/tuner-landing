...
- Kind: `imported`
- Normalized counts: `413` properties, `413` permits, `838` inspections, `5` contractors, `3` rule documents, `1259` source records
- Fixture counts: `413` sequences, `5` pattern slices, `5` repeated slices, max permit support `401`
- Eval counts: `849` tasks, `419` reviewed label rows, `6` repeated next-action groups, `844` dev, `5` test
