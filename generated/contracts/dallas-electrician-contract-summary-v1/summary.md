...
- Kind: `imported`
- Normalized counts: `285` properties, `285` permits, `582` inspections, `5` contractors, `3` rule documents, `875` source records
- Fixture counts: `285` sequences, `5` pattern slices, `5` repeated slices, max permit support `273`
- Eval counts: `593` tasks, `291` reviewed label rows, `6` repeated next-action groups, `588` dev, `5` test
