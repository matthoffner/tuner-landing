...
- Kind: `imported`
- Normalized counts: `72` properties, `72` permits, `156` inspections, `5` contractors, `3` rule documents, `236` source records
- Fixture counts: `72` sequences, `5` pattern slices, `5` repeated slices, max permit support `60`
- Eval counts: `167` tasks, `78` reviewed label rows, `6` repeated next-action groups, `162` dev, `5` test
