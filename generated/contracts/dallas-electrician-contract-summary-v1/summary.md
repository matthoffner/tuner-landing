...
- Kind: `imported`
- Normalized counts: `175` properties, `175` permits, `362` inspections, `5` contractors, `3` rule documents, `545` source records
- Fixture counts: `175` sequences, `5` pattern slices, `5` repeated slices, max permit support `163`
- Eval counts: `373` tasks, `181` reviewed label rows, `6` repeated next-action groups, `368` dev, `5` test
