...
- Kind: `imported`
- Normalized counts: `459` properties, `459` permits, `930` inspections, `5` contractors, `3` rule documents, `1397` source records
- Fixture counts: `459` sequences, `5` pattern slices, `5` repeated slices, max permit support `447`
- Eval counts: `941` tasks, `465` reviewed label rows, `6` repeated next-action groups, `936` dev, `5` test
