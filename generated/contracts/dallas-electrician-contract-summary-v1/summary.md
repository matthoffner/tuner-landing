...
- Kind: `imported`
- Normalized counts: `169` properties, `169` permits, `350` inspections, `5` contractors, `3` rule documents, `527` source records
- Fixture counts: `169` sequences, `5` pattern slices, `5` repeated slices, max permit support `157`
- Eval counts: `361` tasks, `175` reviewed label rows, `6` repeated next-action groups, `356` dev, `5` test
