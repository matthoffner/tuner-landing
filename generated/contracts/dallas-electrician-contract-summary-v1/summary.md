...
- Kind: `imported`
- Normalized counts: `415` properties, `415` permits, `842` inspections, `5` contractors, `3` rule documents, `1265` source records
- Fixture counts: `415` sequences, `5` pattern slices, `5` repeated slices, max permit support `403`
- Eval counts: `853` tasks, `421` reviewed label rows, `6` repeated next-action groups, `848` dev, `5` test
