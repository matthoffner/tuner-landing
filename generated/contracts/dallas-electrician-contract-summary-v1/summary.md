...
- Kind: `imported`
- Normalized counts: `527` properties, `527` permits, `1066` inspections, `5` contractors, `3` rule documents, `1601` source records
- Fixture counts: `527` sequences, `5` pattern slices, `5` repeated slices, max permit support `515`
- Eval counts: `1077` tasks, `533` reviewed label rows, `6` repeated next-action groups, `1072` dev, `5` test
