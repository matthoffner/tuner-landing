...
- Kind: `imported`
- Normalized counts: `61` properties, `61` permits, `134` inspections, `5` contractors, `3` rule documents, `203` source records
- Fixture counts: `61` sequences, `5` pattern slices, `5` repeated slices, max permit support `49`
- Eval counts: `145` tasks, `67` reviewed label rows, `6` repeated next-action groups, `140` dev, `5` test
