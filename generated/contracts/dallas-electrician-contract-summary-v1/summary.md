...
- Kind: `imported`
- Normalized counts: `424` properties, `424` permits, `860` inspections, `5` contractors, `3` rule documents, `1292` source records
- Fixture counts: `424` sequences, `5` pattern slices, `5` repeated slices, max permit support `412`
- Eval counts: `871` tasks, `430` reviewed label rows, `6` repeated next-action groups, `866` dev, `5` test
