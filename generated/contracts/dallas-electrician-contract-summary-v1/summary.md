...
- Kind: `imported`
- Normalized counts: `134` properties, `134` permits, `280` inspections, `5` contractors, `3` rule documents, `422` source records
- Fixture counts: `134` sequences, `5` pattern slices, `5` repeated slices, max permit support `122`
- Eval counts: `291` tasks, `140` reviewed label rows, `6` repeated next-action groups, `286` dev, `5` test
