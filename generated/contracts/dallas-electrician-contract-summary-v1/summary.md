...
- Kind: `imported`
- Normalized counts: `131` properties, `131` permits, `274` inspections, `5` contractors, `3` rule documents, `413` source records
- Fixture counts: `131` sequences, `5` pattern slices, `5` repeated slices, max permit support `119`
- Eval counts: `285` tasks, `137` reviewed label rows, `6` repeated next-action groups, `280` dev, `5` test
