...
- Kind: `imported`
- Normalized counts: `206` properties, `206` permits, `424` inspections, `5` contractors, `3` rule documents, `638` source records
- Fixture counts: `206` sequences, `5` pattern slices, `5` repeated slices, max permit support `194`
- Eval counts: `435` tasks, `212` reviewed label rows, `6` repeated next-action groups, `430` dev, `5` test
