...
- Kind: `imported`
- Normalized counts: `321` properties, `321` permits, `654` inspections, `5` contractors, `3` rule documents, `983` source records
- Fixture counts: `321` sequences, `5` pattern slices, `5` repeated slices, max permit support `309`
- Eval counts: `665` tasks, `327` reviewed label rows, `6` repeated next-action groups, `660` dev, `5` test
