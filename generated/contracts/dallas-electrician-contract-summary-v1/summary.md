...
- Kind: `imported`
- Normalized counts: `342` properties, `342` permits, `696` inspections, `5` contractors, `3` rule documents, `1046` source records
- Fixture counts: `342` sequences, `5` pattern slices, `5` repeated slices, max permit support `330`
- Eval counts: `707` tasks, `348` reviewed label rows, `6` repeated next-action groups, `702` dev, `5` test
