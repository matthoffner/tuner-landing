...
- Kind: `imported`
- Normalized counts: `51` properties, `51` permits, `114` inspections, `5` contractors, `3` rule documents, `173` source records
- Fixture counts: `51` sequences, `5` pattern slices, `5` repeated slices, max permit support `39`
- Eval counts: `125` tasks, `57` reviewed label rows, `6` repeated next-action groups, `120` dev, `5` test
