...
- Kind: `imported`
- Normalized counts: `254` properties, `254` permits, `520` inspections, `5` contractors, `3` rule documents, `782` source records
- Fixture counts: `254` sequences, `5` pattern slices, `5` repeated slices, max permit support `242`
- Eval counts: `531` tasks, `260` reviewed label rows, `6` repeated next-action groups, `526` dev, `5` test
