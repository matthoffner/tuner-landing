...
- Kind: `imported`
- Normalized counts: `151` properties, `151` permits, `314` inspections, `5` contractors, `3` rule documents, `473` source records
- Fixture counts: `151` sequences, `5` pattern slices, `5` repeated slices, max permit support `139`
- Eval counts: `325` tasks, `157` reviewed label rows, `6` repeated next-action groups, `320` dev, `5` test
