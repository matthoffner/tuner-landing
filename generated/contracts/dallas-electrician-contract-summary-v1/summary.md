...
- Kind: `imported`
- Normalized counts: `52` properties, `52` permits, `116` inspections, `5` contractors, `3` rule documents, `176` source records
- Fixture counts: `52` sequences, `5` pattern slices, `5` repeated slices, max permit support `40`
- Eval counts: `127` tasks, `58` reviewed label rows, `6` repeated next-action groups, `122` dev, `5` test
