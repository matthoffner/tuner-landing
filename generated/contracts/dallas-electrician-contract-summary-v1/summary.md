...
- Kind: `imported`
- Normalized counts: `441` properties, `441` permits, `894` inspections, `5` contractors, `3` rule documents, `1343` source records
- Fixture counts: `441` sequences, `5` pattern slices, `5` repeated slices, max permit support `429`
- Eval counts: `905` tasks, `447` reviewed label rows, `6` repeated next-action groups, `900` dev, `5` test
