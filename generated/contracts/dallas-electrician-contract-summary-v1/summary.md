...
- Kind: `imported`
- Normalized counts: `26` properties, `26` permits, `64` inspections, `5` contractors, `3` rule documents, `98` source records
- Fixture counts: `26` sequences, `5` pattern slices, `5` repeated slices, max permit support `14`
- Eval counts: `75` tasks, `32` reviewed label rows, `6` repeated next-action groups, `70` dev, `5` test
