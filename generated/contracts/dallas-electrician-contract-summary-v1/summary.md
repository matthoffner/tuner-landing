...
- Kind: `imported`
- Normalized counts: `332` properties, `332` permits, `676` inspections, `5` contractors, `3` rule documents, `1016` source records
- Fixture counts: `332` sequences, `5` pattern slices, `5` repeated slices, max permit support `320`
- Eval counts: `687` tasks, `338` reviewed label rows, `6` repeated next-action groups, `682` dev, `5` test
