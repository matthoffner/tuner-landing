...
- Kind: `imported`
- Normalized counts: `255` properties, `255` permits, `522` inspections, `5` contractors, `3` rule documents, `785` source records
- Fixture counts: `255` sequences, `5` pattern slices, `5` repeated slices, max permit support `243`
- Eval counts: `533` tasks, `261` reviewed label rows, `6` repeated next-action groups, `528` dev, `5` test
