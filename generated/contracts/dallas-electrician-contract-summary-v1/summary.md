...
- Kind: `imported`
- Normalized counts: `164` properties, `164` permits, `340` inspections, `5` contractors, `3` rule documents, `512` source records
- Fixture counts: `164` sequences, `5` pattern slices, `5` repeated slices, max permit support `152`
- Eval counts: `351` tasks, `170` reviewed label rows, `6` repeated next-action groups, `346` dev, `5` test
