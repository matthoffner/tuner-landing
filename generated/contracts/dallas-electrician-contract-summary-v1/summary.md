...
- Kind: `imported`
- Normalized counts: `73` properties, `73` permits, `158` inspections, `5` contractors, `3` rule documents, `239` source records
- Fixture counts: `73` sequences, `5` pattern slices, `5` repeated slices, max permit support `61`
- Eval counts: `169` tasks, `79` reviewed label rows, `6` repeated next-action groups, `164` dev, `5` test
