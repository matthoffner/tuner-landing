...
- Kind: `imported`
- Normalized counts: `118` properties, `118` permits, `248` inspections, `5` contractors, `3` rule documents, `374` source records
- Fixture counts: `118` sequences, `5` pattern slices, `5` repeated slices, max permit support `106`
- Eval counts: `259` tasks, `124` reviewed label rows, `6` repeated next-action groups, `254` dev, `5` test
