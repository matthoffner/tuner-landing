...
- Kind: `imported`
- Normalized counts: `160` properties, `160` permits, `332` inspections, `5` contractors, `3` rule documents, `500` source records
- Fixture counts: `160` sequences, `5` pattern slices, `5` repeated slices, max permit support `148`
- Eval counts: `343` tasks, `166` reviewed label rows, `6` repeated next-action groups, `338` dev, `5` test
