...
- Kind: `imported`
- Normalized counts: `173` properties, `173` permits, `358` inspections, `5` contractors, `3` rule documents, `539` source records
- Fixture counts: `173` sequences, `5` pattern slices, `5` repeated slices, max permit support `161`
- Eval counts: `369` tasks, `179` reviewed label rows, `6` repeated next-action groups, `364` dev, `5` test
