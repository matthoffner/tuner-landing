...
- Kind: `imported`
- Normalized counts: `487` properties, `487` permits, `986` inspections, `5` contractors, `3` rule documents, `1481` source records
- Fixture counts: `487` sequences, `5` pattern slices, `5` repeated slices, max permit support `475`
- Eval counts: `997` tasks, `493` reviewed label rows, `6` repeated next-action groups, `992` dev, `5` test
