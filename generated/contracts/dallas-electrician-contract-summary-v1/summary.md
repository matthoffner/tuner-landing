...
- Kind: `imported`
- Normalized counts: `276` properties, `276` permits, `564` inspections, `5` contractors, `3` rule documents, `848` source records
- Fixture counts: `276` sequences, `5` pattern slices, `5` repeated slices, max permit support `264`
- Eval counts: `575` tasks, `282` reviewed label rows, `6` repeated next-action groups, `570` dev, `5` test
