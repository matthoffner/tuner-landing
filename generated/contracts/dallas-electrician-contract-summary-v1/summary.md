...
- Kind: `imported`
- Normalized counts: `24` properties, `24` permits, `60` inspections, `5` contractors, `3` rule documents, `92` source records
- Fixture counts: `24` sequences, `5` pattern slices, `5` repeated slices, max permit support `12`
- Eval counts: `71` tasks, `30` reviewed label rows, `6` repeated next-action groups, `66` dev, `5` test
