...
- Kind: `imported`
- Normalized counts: `191` properties, `191` permits, `394` inspections, `5` contractors, `3` rule documents, `593` source records
- Fixture counts: `191` sequences, `5` pattern slices, `5` repeated slices, max permit support `179`
- Eval counts: `405` tasks, `197` reviewed label rows, `6` repeated next-action groups, `400` dev, `5` test
