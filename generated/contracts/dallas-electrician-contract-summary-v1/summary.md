...
- Kind: `imported`
- Normalized counts: `289` properties, `289` permits, `590` inspections, `5` contractors, `3` rule documents, `887` source records
- Fixture counts: `289` sequences, `5` pattern slices, `5` repeated slices, max permit support `277`
- Eval counts: `601` tasks, `295` reviewed label rows, `6` repeated next-action groups, `596` dev, `5` test
