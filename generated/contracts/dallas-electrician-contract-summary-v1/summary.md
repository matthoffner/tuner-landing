...
- Kind: `imported`
- Normalized counts: `76` properties, `76` permits, `164` inspections, `5` contractors, `3` rule documents, `248` source records
- Fixture counts: `76` sequences, `5` pattern slices, `5` repeated slices, max permit support `64`
- Eval counts: `175` tasks, `82` reviewed label rows, `6` repeated next-action groups, `170` dev, `5` test
