...
- Kind: `imported`
- Normalized counts: `246` properties, `246` permits, `504` inspections, `5` contractors, `3` rule documents, `758` source records
- Fixture counts: `246` sequences, `5` pattern slices, `5` repeated slices, max permit support `234`
- Eval counts: `515` tasks, `252` reviewed label rows, `6` repeated next-action groups, `510` dev, `5` test
