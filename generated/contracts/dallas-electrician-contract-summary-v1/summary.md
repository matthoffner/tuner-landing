...
- Kind: `imported`
- Normalized counts: `146` properties, `146` permits, `304` inspections, `5` contractors, `3` rule documents, `458` source records
- Fixture counts: `146` sequences, `5` pattern slices, `5` repeated slices, max permit support `134`
- Eval counts: `315` tasks, `152` reviewed label rows, `6` repeated next-action groups, `310` dev, `5` test
