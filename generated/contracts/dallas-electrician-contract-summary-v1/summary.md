...
- Kind: `imported`
- Normalized counts: `133` properties, `133` permits, `278` inspections, `5` contractors, `3` rule documents, `419` source records
- Fixture counts: `133` sequences, `5` pattern slices, `5` repeated slices, max permit support `121`
- Eval counts: `289` tasks, `139` reviewed label rows, `6` repeated next-action groups, `284` dev, `5` test
