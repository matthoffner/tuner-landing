...
- Kind: `imported`
- Normalized counts: `126` properties, `126` permits, `264` inspections, `5` contractors, `3` rule documents, `398` source records
- Fixture counts: `126` sequences, `5` pattern slices, `5` repeated slices, max permit support `114`
- Eval counts: `275` tasks, `132` reviewed label rows, `6` repeated next-action groups, `270` dev, `5` test
