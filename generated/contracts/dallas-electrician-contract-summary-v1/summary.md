...
- Kind: `imported`
- Normalized counts: `215` properties, `215` permits, `442` inspections, `5` contractors, `3` rule documents, `665` source records
- Fixture counts: `215` sequences, `5` pattern slices, `5` repeated slices, max permit support `203`
- Eval counts: `453` tasks, `221` reviewed label rows, `6` repeated next-action groups, `448` dev, `5` test
