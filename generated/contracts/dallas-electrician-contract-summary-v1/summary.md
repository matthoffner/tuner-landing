...
- Kind: `imported`
- Normalized counts: `316` properties, `316` permits, `644` inspections, `5` contractors, `3` rule documents, `968` source records
- Fixture counts: `316` sequences, `5` pattern slices, `5` repeated slices, max permit support `304`
- Eval counts: `655` tasks, `322` reviewed label rows, `6` repeated next-action groups, `650` dev, `5` test
