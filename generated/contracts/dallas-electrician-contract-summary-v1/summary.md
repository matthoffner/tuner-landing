...
- Kind: `imported`
- Normalized counts: `449` properties, `449` permits, `910` inspections, `5` contractors, `3` rule documents, `1367` source records
- Fixture counts: `449` sequences, `5` pattern slices, `5` repeated slices, max permit support `437`
- Eval counts: `921` tasks, `455` reviewed label rows, `6` repeated next-action groups, `916` dev, `5` test
