...
- Kind: `imported`
- Normalized counts: `517` properties, `517` permits, `1046` inspections, `5` contractors, `3` rule documents, `1571` source records
- Fixture counts: `517` sequences, `5` pattern slices, `5` repeated slices, max permit support `505`
- Eval counts: `1057` tasks, `523` reviewed label rows, `6` repeated next-action groups, `1052` dev, `5` test
