...
- Kind: `imported`
- Normalized counts: `490` properties, `490` permits, `992` inspections, `5` contractors, `3` rule documents, `1490` source records
- Fixture counts: `490` sequences, `5` pattern slices, `5` repeated slices, max permit support `478`
- Eval counts: `1003` tasks, `496` reviewed label rows, `6` repeated next-action groups, `998` dev, `5` test
