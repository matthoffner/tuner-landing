...
- Kind: `imported`
- Normalized counts: `461` properties, `461` permits, `934` inspections, `5` contractors, `3` rule documents, `1403` source records
- Fixture counts: `461` sequences, `5` pattern slices, `5` repeated slices, max permit support `449`
- Eval counts: `945` tasks, `467` reviewed label rows, `6` repeated next-action groups, `940` dev, `5` test
