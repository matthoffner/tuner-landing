...
- Kind: `imported`
- Normalized counts: `231` properties, `231` permits, `474` inspections, `5` contractors, `3` rule documents, `713` source records
- Fixture counts: `231` sequences, `5` pattern slices, `5` repeated slices, max permit support `219`
- Eval counts: `485` tasks, `237` reviewed label rows, `6` repeated next-action groups, `480` dev, `5` test
