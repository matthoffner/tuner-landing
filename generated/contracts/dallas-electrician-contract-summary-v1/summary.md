...
- Kind: `imported`
- Normalized counts: `479` properties, `479` permits, `970` inspections, `5` contractors, `3` rule documents, `1457` source records
- Fixture counts: `479` sequences, `5` pattern slices, `5` repeated slices, max permit support `467`
- Eval counts: `981` tasks, `485` reviewed label rows, `6` repeated next-action groups, `976` dev, `5` test
