...
- Kind: `imported`
- Normalized counts: `390` properties, `390` permits, `792` inspections, `5` contractors, `3` rule documents, `1190` source records
- Fixture counts: `390` sequences, `5` pattern slices, `5` repeated slices, max permit support `378`
- Eval counts: `803` tasks, `396` reviewed label rows, `6` repeated next-action groups, `798` dev, `5` test
