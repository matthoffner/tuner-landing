...
- Kind: `imported`
- Normalized counts: `264` properties, `264` permits, `540` inspections, `5` contractors, `3` rule documents, `812` source records
- Fixture counts: `264` sequences, `5` pattern slices, `5` repeated slices, max permit support `252`
- Eval counts: `551` tasks, `270` reviewed label rows, `6` repeated next-action groups, `546` dev, `5` test
