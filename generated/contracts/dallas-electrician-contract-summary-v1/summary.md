...
- Kind: `imported`
- Normalized counts: `535` properties, `535` permits, `1082` inspections, `5` contractors, `3` rule documents, `1625` source records
- Fixture counts: `535` sequences, `5` pattern slices, `5` repeated slices, max permit support `523`
- Eval counts: `1093` tasks, `541` reviewed label rows, `6` repeated next-action groups, `1088` dev, `5` test
