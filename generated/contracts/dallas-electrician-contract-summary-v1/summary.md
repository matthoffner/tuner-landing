...
- Kind: `imported`
- Normalized counts: `132` properties, `132` permits, `276` inspections, `5` contractors, `3` rule documents, `416` source records
- Fixture counts: `132` sequences, `5` pattern slices, `5` repeated slices, max permit support `120`
- Eval counts: `287` tasks, `138` reviewed label rows, `6` repeated next-action groups, `282` dev, `5` test
