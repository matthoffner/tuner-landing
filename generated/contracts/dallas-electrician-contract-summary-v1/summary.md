...
- Kind: `imported`
- Normalized counts: `292` properties, `292` permits, `596` inspections, `5` contractors, `3` rule documents, `896` source records
- Fixture counts: `292` sequences, `5` pattern slices, `5` repeated slices, max permit support `280`
- Eval counts: `607` tasks, `298` reviewed label rows, `6` repeated next-action groups, `602` dev, `5` test
