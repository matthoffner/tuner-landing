...
- Kind: `imported`
- Normalized counts: `288` properties, `288` permits, `588` inspections, `5` contractors, `3` rule documents, `884` source records
- Fixture counts: `288` sequences, `5` pattern slices, `5` repeated slices, max permit support `276`
- Eval counts: `599` tasks, `294` reviewed label rows, `6` repeated next-action groups, `594` dev, `5` test
