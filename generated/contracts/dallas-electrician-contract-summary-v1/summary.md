...
- Kind: `imported`
- Normalized counts: `25` properties, `25` permits, `62` inspections, `5` contractors, `3` rule documents, `95` source records
- Fixture counts: `25` sequences, `5` pattern slices, `5` repeated slices, max permit support `13`
- Eval counts: `73` tasks, `31` reviewed label rows, `6` repeated next-action groups, `68` dev, `5` test
