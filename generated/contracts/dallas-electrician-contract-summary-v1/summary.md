...
- Kind: `imported`
- Normalized counts: `106` properties, `106` permits, `224` inspections, `5` contractors, `3` rule documents, `338` source records
- Fixture counts: `106` sequences, `5` pattern slices, `5` repeated slices, max permit support `94`
- Eval counts: `235` tasks, `112` reviewed label rows, `6` repeated next-action groups, `230` dev, `5` test
