...
- Kind: `imported`
- Normalized counts: `225` properties, `225` permits, `462` inspections, `5` contractors, `3` rule documents, `695` source records
- Fixture counts: `225` sequences, `5` pattern slices, `5` repeated slices, max permit support `213`
- Eval counts: `473` tasks, `231` reviewed label rows, `6` repeated next-action groups, `468` dev, `5` test
