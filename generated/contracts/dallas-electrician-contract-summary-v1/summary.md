...
- Kind: `imported`
- Normalized counts: `152` properties, `152` permits, `316` inspections, `5` contractors, `3` rule documents, `476` source records
- Fixture counts: `152` sequences, `5` pattern slices, `5` repeated slices, max permit support `140`
- Eval counts: `327` tasks, `158` reviewed label rows, `6` repeated next-action groups, `322` dev, `5` test
