...
- Kind: `imported`
- Normalized counts: `43` properties, `43` permits, `98` inspections, `5` contractors, `3` rule documents, `149` source records
- Fixture counts: `43` sequences, `5` pattern slices, `5` repeated slices, max permit support `31`
- Eval counts: `109` tasks, `49` reviewed label rows, `6` repeated next-action groups, `104` dev, `5` test
