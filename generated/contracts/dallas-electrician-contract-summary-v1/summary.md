...
- Kind: `imported`
- Normalized counts: `253` properties, `253` permits, `518` inspections, `5` contractors, `3` rule documents, `779` source records
- Fixture counts: `253` sequences, `5` pattern slices, `5` repeated slices, max permit support `241`
- Eval counts: `529` tasks, `259` reviewed label rows, `6` repeated next-action groups, `524` dev, `5` test
