...
- Kind: `imported`
- Normalized counts: `462` properties, `462` permits, `936` inspections, `5` contractors, `3` rule documents, `1406` source records
- Fixture counts: `462` sequences, `5` pattern slices, `5` repeated slices, max permit support `450`
- Eval counts: `947` tasks, `468` reviewed label rows, `6` repeated next-action groups, `942` dev, `5` test
