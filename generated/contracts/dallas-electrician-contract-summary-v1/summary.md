...
- Kind: `imported`
- Normalized counts: `439` properties, `439` permits, `890` inspections, `5` contractors, `3` rule documents, `1337` source records
- Fixture counts: `439` sequences, `5` pattern slices, `5` repeated slices, max permit support `427`
- Eval counts: `901` tasks, `445` reviewed label rows, `6` repeated next-action groups, `896` dev, `5` test
