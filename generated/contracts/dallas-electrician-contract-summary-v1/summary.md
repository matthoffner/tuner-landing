...
- Kind: `imported`
- Normalized counts: `71` properties, `71` permits, `154` inspections, `5` contractors, `3` rule documents, `233` source records
- Fixture counts: `71` sequences, `5` pattern slices, `5` repeated slices, max permit support `59`
- Eval counts: `165` tasks, `77` reviewed label rows, `6` repeated next-action groups, `160` dev, `5` test
