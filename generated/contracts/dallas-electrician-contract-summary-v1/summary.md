...
- Kind: `imported`
- Normalized counts: `484` properties, `484` permits, `980` inspections, `5` contractors, `3` rule documents, `1472` source records
- Fixture counts: `484` sequences, `5` pattern slices, `5` repeated slices, max permit support `472`
- Eval counts: `991` tasks, `490` reviewed label rows, `6` repeated next-action groups, `986` dev, `5` test
