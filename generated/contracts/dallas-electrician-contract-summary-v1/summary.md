...
- Kind: `imported`
- Normalized counts: `456` properties, `456` permits, `924` inspections, `5` contractors, `3` rule documents, `1388` source records
- Fixture counts: `456` sequences, `5` pattern slices, `5` repeated slices, max permit support `444`
- Eval counts: `935` tasks, `462` reviewed label rows, `6` repeated next-action groups, `930` dev, `5` test
