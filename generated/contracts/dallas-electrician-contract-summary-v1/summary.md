...
- Kind: `imported`
- Normalized counts: `224` properties, `224` permits, `460` inspections, `5` contractors, `3` rule documents, `692` source records
- Fixture counts: `224` sequences, `5` pattern slices, `5` repeated slices, max permit support `212`
- Eval counts: `471` tasks, `230` reviewed label rows, `6` repeated next-action groups, `466` dev, `5` test
