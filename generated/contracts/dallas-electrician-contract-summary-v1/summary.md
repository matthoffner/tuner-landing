...
- Kind: `imported`
- Normalized counts: `363` properties, `363` permits, `738` inspections, `5` contractors, `3` rule documents, `1109` source records
- Fixture counts: `363` sequences, `5` pattern slices, `5` repeated slices, max permit support `351`
- Eval counts: `749` tasks, `369` reviewed label rows, `6` repeated next-action groups, `744` dev, `5` test
