...
- Kind: `imported`
- Normalized counts: `510` properties, `510` permits, `1032` inspections, `5` contractors, `3` rule documents, `1550` source records
- Fixture counts: `510` sequences, `5` pattern slices, `5` repeated slices, max permit support `498`
- Eval counts: `1043` tasks, `516` reviewed label rows, `6` repeated next-action groups, `1038` dev, `5` test
