...
- Kind: `imported`
- Normalized counts: `207` properties, `207` permits, `426` inspections, `5` contractors, `3` rule documents, `641` source records
- Fixture counts: `207` sequences, `5` pattern slices, `5` repeated slices, max permit support `195`
- Eval counts: `437` tasks, `213` reviewed label rows, `6` repeated next-action groups, `432` dev, `5` test
