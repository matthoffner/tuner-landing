...
- Kind: `imported`
- Normalized counts: `420` properties, `420` permits, `852` inspections, `5` contractors, `3` rule documents, `1280` source records
- Fixture counts: `420` sequences, `5` pattern slices, `5` repeated slices, max permit support `408`
- Eval counts: `863` tasks, `426` reviewed label rows, `6` repeated next-action groups, `858` dev, `5` test
