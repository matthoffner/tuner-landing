...
- Kind: `imported`
- Normalized counts: `333` properties, `333` permits, `678` inspections, `5` contractors, `3` rule documents, `1019` source records
- Fixture counts: `333` sequences, `5` pattern slices, `5` repeated slices, max permit support `321`
- Eval counts: `689` tasks, `339` reviewed label rows, `6` repeated next-action groups, `684` dev, `5` test
