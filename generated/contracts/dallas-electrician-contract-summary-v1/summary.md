...
- Kind: `imported`
- Normalized counts: `389` properties, `389` permits, `790` inspections, `5` contractors, `3` rule documents, `1187` source records
- Fixture counts: `389` sequences, `5` pattern slices, `5` repeated slices, max permit support `377`
- Eval counts: `801` tasks, `395` reviewed label rows, `6` repeated next-action groups, `796` dev, `5` test
