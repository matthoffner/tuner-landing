...
- Kind: `imported`
- Normalized counts: `55` properties, `55` permits, `122` inspections, `5` contractors, `3` rule documents, `185` source records
- Fixture counts: `55` sequences, `5` pattern slices, `5` repeated slices, max permit support `43`
- Eval counts: `133` tasks, `61` reviewed label rows, `6` repeated next-action groups, `128` dev, `5` test
