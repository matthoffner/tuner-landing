...
- Kind: `imported`
- Normalized counts: `261` properties, `261` permits, `534` inspections, `5` contractors, `3` rule documents, `803` source records
- Fixture counts: `261` sequences, `5` pattern slices, `5` repeated slices, max permit support `249`
- Eval counts: `545` tasks, `267` reviewed label rows, `6` repeated next-action groups, `540` dev, `5` test
