...
- Kind: `imported`
- Normalized counts: `19` properties, `19` permits, `50` inspections, `5` contractors, `3` rule documents, `77` source records
- Fixture counts: `19` sequences, `5` pattern slices, `5` repeated slices, max permit support `7`
- Eval counts: `61` tasks, `25` reviewed label rows, `6` repeated next-action groups, `56` dev, `5` test
