...
- Kind: `imported`
- Normalized counts: `174` properties, `174` permits, `360` inspections, `5` contractors, `3` rule documents, `542` source records
- Fixture counts: `174` sequences, `5` pattern slices, `5` repeated slices, max permit support `162`
- Eval counts: `371` tasks, `180` reviewed label rows, `6` repeated next-action groups, `366` dev, `5` test
