...
- Kind: `imported`
- Normalized counts: `241` properties, `241` permits, `494` inspections, `5` contractors, `3` rule documents, `743` source records
- Fixture counts: `241` sequences, `5` pattern slices, `5` repeated slices, max permit support `229`
- Eval counts: `505` tasks, `247` reviewed label rows, `6` repeated next-action groups, `500` dev, `5` test
