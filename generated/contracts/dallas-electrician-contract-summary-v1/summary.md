...
- Kind: `imported`
- Normalized counts: `216` properties, `216` permits, `444` inspections, `5` contractors, `3` rule documents, `668` source records
- Fixture counts: `216` sequences, `5` pattern slices, `5` repeated slices, max permit support `204`
- Eval counts: `455` tasks, `222` reviewed label rows, `6` repeated next-action groups, `450` dev, `5` test
