...
- Kind: `imported`
- Normalized counts: `464` properties, `464` permits, `940` inspections, `5` contractors, `3` rule documents, `1412` source records
- Fixture counts: `464` sequences, `5` pattern slices, `5` repeated slices, max permit support `452`
- Eval counts: `951` tasks, `470` reviewed label rows, `6` repeated next-action groups, `946` dev, `5` test
