...
- Kind: `imported`
- Normalized counts: `483` properties, `483` permits, `978` inspections, `5` contractors, `3` rule documents, `1469` source records
- Fixture counts: `483` sequences, `5` pattern slices, `5` repeated slices, max permit support `471`
- Eval counts: `989` tasks, `489` reviewed label rows, `6` repeated next-action groups, `984` dev, `5` test
