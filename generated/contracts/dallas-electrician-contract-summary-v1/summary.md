...
- Kind: `imported`
- Normalized counts: `205` properties, `205` permits, `422` inspections, `5` contractors, `3` rule documents, `635` source records
- Fixture counts: `205` sequences, `5` pattern slices, `5` repeated slices, max permit support `193`
- Eval counts: `433` tasks, `211` reviewed label rows, `6` repeated next-action groups, `428` dev, `5` test
