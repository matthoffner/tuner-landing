...
- Kind: `imported`
- Normalized counts: `460` properties, `460` permits, `932` inspections, `5` contractors, `3` rule documents, `1400` source records
- Fixture counts: `460` sequences, `5` pattern slices, `5` repeated slices, max permit support `448`
- Eval counts: `943` tasks, `466` reviewed label rows, `6` repeated next-action groups, `938` dev, `5` test
