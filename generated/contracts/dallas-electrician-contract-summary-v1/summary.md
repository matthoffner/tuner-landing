...
- Kind: `imported`
- Normalized counts: `53` properties, `53` permits, `118` inspections, `5` contractors, `3` rule documents, `179` source records
- Fixture counts: `53` sequences, `5` pattern slices, `5` repeated slices, max permit support `41`
- Eval counts: `129` tasks, `59` reviewed label rows, `6` repeated next-action groups, `124` dev, `5` test
