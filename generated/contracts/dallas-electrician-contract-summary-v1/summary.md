...
- Kind: `imported`
- Normalized counts: `240` properties, `240` permits, `492` inspections, `5` contractors, `3` rule documents, `740` source records
- Fixture counts: `240` sequences, `5` pattern slices, `5` repeated slices, max permit support `228`
- Eval counts: `503` tasks, `246` reviewed label rows, `6` repeated next-action groups, `498` dev, `5` test
