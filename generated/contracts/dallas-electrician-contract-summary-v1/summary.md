...
- Kind: `imported`
- Normalized counts: `346` properties, `346` permits, `704` inspections, `5` contractors, `3` rule documents, `1058` source records
- Fixture counts: `346` sequences, `5` pattern slices, `5` repeated slices, max permit support `334`
- Eval counts: `715` tasks, `352` reviewed label rows, `6` repeated next-action groups, `710` dev, `5` test
