...
- Kind: `imported`
- Normalized counts: `315` properties, `315` permits, `642` inspections, `5` contractors, `3` rule documents, `965` source records
- Fixture counts: `315` sequences, `5` pattern slices, `5` repeated slices, max permit support `303`
- Eval counts: `653` tasks, `321` reviewed label rows, `6` repeated next-action groups, `648` dev, `5` test
