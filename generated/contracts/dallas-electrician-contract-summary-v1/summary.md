...
- Kind: `imported`
- Normalized counts: `116` properties, `116` permits, `244` inspections, `5` contractors, `3` rule documents, `368` source records
- Fixture counts: `116` sequences, `5` pattern slices, `5` repeated slices, max permit support `104`
- Eval counts: `255` tasks, `122` reviewed label rows, `6` repeated next-action groups, `250` dev, `5` test
