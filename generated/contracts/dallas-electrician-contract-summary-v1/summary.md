...
- Kind: `imported`
- Normalized counts: `185` properties, `185` permits, `382` inspections, `5` contractors, `3` rule documents, `575` source records
- Fixture counts: `185` sequences, `5` pattern slices, `5` repeated slices, max permit support `173`
- Eval counts: `393` tasks, `191` reviewed label rows, `6` repeated next-action groups, `388` dev, `5` test
