...
- Kind: `imported`
- Normalized counts: `440` properties, `440` permits, `892` inspections, `5` contractors, `3` rule documents, `1340` source records
- Fixture counts: `440` sequences, `5` pattern slices, `5` repeated slices, max permit support `428`
- Eval counts: `903` tasks, `446` reviewed label rows, `6` repeated next-action groups, `898` dev, `5` test
