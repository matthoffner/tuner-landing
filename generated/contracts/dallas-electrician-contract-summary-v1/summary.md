...
- Kind: `imported`
- Normalized counts: `97` properties, `97` permits, `206` inspections, `5` contractors, `3` rule documents, `311` source records
- Fixture counts: `97` sequences, `5` pattern slices, `5` repeated slices, max permit support `85`
- Eval counts: `217` tasks, `103` reviewed label rows, `6` repeated next-action groups, `212` dev, `5` test
