...
- Kind: `imported`
- Normalized counts: `454` properties, `454` permits, `920` inspections, `5` contractors, `3` rule documents, `1382` source records
- Fixture counts: `454` sequences, `5` pattern slices, `5` repeated slices, max permit support `442`
- Eval counts: `931` tasks, `460` reviewed label rows, `6` repeated next-action groups, `926` dev, `5` test
