...
- Kind: `imported`
- Normalized counts: `189` properties, `189` permits, `390` inspections, `5` contractors, `3` rule documents, `587` source records
- Fixture counts: `189` sequences, `5` pattern slices, `5` repeated slices, max permit support `177`
- Eval counts: `401` tasks, `195` reviewed label rows, `6` repeated next-action groups, `396` dev, `5` test
