...
- Kind: `imported`
- Normalized counts: `455` properties, `455` permits, `922` inspections, `5` contractors, `3` rule documents, `1385` source records
- Fixture counts: `455` sequences, `5` pattern slices, `5` repeated slices, max permit support `443`
- Eval counts: `933` tasks, `461` reviewed label rows, `6` repeated next-action groups, `928` dev, `5` test
