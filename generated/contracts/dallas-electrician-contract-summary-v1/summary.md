...
- Kind: `imported`
- Normalized counts: `188` properties, `188` permits, `388` inspections, `5` contractors, `3` rule documents, `584` source records
- Fixture counts: `188` sequences, `5` pattern slices, `5` repeated slices, max permit support `176`
- Eval counts: `399` tasks, `194` reviewed label rows, `6` repeated next-action groups, `394` dev, `5` test
