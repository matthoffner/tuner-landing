...
- Kind: `imported`
- Normalized counts: `476` properties, `476` permits, `964` inspections, `5` contractors, `3` rule documents, `1448` source records
- Fixture counts: `476` sequences, `5` pattern slices, `5` repeated slices, max permit support `464`
- Eval counts: `975` tasks, `482` reviewed label rows, `6` repeated next-action groups, `970` dev, `5` test
