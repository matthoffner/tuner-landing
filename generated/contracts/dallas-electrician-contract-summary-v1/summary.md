...
- Kind: `imported`
- Normalized counts: `145` properties, `145` permits, `302` inspections, `5` contractors, `3` rule documents, `455` source records
- Fixture counts: `145` sequences, `5` pattern slices, `5` repeated slices, max permit support `133`
- Eval counts: `313` tasks, `151` reviewed label rows, `6` repeated next-action groups, `308` dev, `5` test
