...
- Kind: `imported`
- Normalized counts: `408` properties, `408` permits, `828` inspections, `5` contractors, `3` rule documents, `1244` source records
- Fixture counts: `408` sequences, `5` pattern slices, `5` repeated slices, max permit support `396`
- Eval counts: `839` tasks, `414` reviewed label rows, `6` repeated next-action groups, `834` dev, `5` test
