...
- Kind: `imported`
- Normalized counts: `361` properties, `361` permits, `734` inspections, `5` contractors, `3` rule documents, `1103` source records
- Fixture counts: `361` sequences, `5` pattern slices, `5` repeated slices, max permit support `349`
- Eval counts: `745` tasks, `367` reviewed label rows, `6` repeated next-action groups, `740` dev, `5` test
