...
- Kind: `imported`
- Normalized counts: `165` properties, `165` permits, `342` inspections, `5` contractors, `3` rule documents, `515` source records
- Fixture counts: `165` sequences, `5` pattern slices, `5` repeated slices, max permit support `153`
- Eval counts: `353` tasks, `171` reviewed label rows, `6` repeated next-action groups, `348` dev, `5` test
