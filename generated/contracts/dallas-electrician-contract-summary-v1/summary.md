...
- Kind: `imported`
- Normalized counts: `247` properties, `247` permits, `506` inspections, `5` contractors, `3` rule documents, `761` source records
- Fixture counts: `247` sequences, `5` pattern slices, `5` repeated slices, max permit support `235`
- Eval counts: `517` tasks, `253` reviewed label rows, `6` repeated next-action groups, `512` dev, `5` test
