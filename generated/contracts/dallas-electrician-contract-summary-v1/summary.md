...
- Kind: `imported`
- Normalized counts: `119` properties, `119` permits, `250` inspections, `5` contractors, `3` rule documents, `377` source records
- Fixture counts: `119` sequences, `5` pattern slices, `5` repeated slices, max permit support `107`
- Eval counts: `261` tasks, `125` reviewed label rows, `6` repeated next-action groups, `256` dev, `5` test
