...
- Kind: `imported`
- Normalized counts: `392` properties, `392` permits, `796` inspections, `5` contractors, `3` rule documents, `1196` source records
- Fixture counts: `392` sequences, `5` pattern slices, `5` repeated slices, max permit support `380`
- Eval counts: `807` tasks, `398` reviewed label rows, `6` repeated next-action groups, `802` dev, `5` test
