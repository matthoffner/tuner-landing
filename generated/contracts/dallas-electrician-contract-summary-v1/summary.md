...
- Kind: `imported`
- Normalized counts: `248` properties, `248` permits, `508` inspections, `5` contractors, `3` rule documents, `764` source records
- Fixture counts: `248` sequences, `5` pattern slices, `5` repeated slices, max permit support `236`
- Eval counts: `519` tasks, `254` reviewed label rows, `6` repeated next-action groups, `514` dev, `5` test
