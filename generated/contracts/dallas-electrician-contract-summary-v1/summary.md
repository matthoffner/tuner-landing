...
- Kind: `imported`
- Normalized counts: `375` properties, `375` permits, `762` inspections, `5` contractors, `3` rule documents, `1145` source records
- Fixture counts: `375` sequences, `5` pattern slices, `5` repeated slices, max permit support `363`
- Eval counts: `773` tasks, `381` reviewed label rows, `6` repeated next-action groups, `768` dev, `5` test
