...
- Kind: `imported`
- Normalized counts: `277` properties, `277` permits, `566` inspections, `5` contractors, `3` rule documents, `851` source records
- Fixture counts: `277` sequences, `5` pattern slices, `5` repeated slices, max permit support `265`
- Eval counts: `577` tasks, `283` reviewed label rows, `6` repeated next-action groups, `572` dev, `5` test
