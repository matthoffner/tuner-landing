...
- Kind: `imported`
- Normalized counts: `138` properties, `138` permits, `288` inspections, `5` contractors, `3` rule documents, `434` source records
- Fixture counts: `138` sequences, `5` pattern slices, `5` repeated slices, max permit support `126`
- Eval counts: `299` tasks, `144` reviewed label rows, `6` repeated next-action groups, `294` dev, `5` test
