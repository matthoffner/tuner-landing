...
- Kind: `imported`
- Normalized counts: `317` properties, `317` permits, `646` inspections, `5` contractors, `3` rule documents, `971` source records
- Fixture counts: `317` sequences, `5` pattern slices, `5` repeated slices, max permit support `305`
- Eval counts: `657` tasks, `323` reviewed label rows, `6` repeated next-action groups, `652` dev, `5` test
