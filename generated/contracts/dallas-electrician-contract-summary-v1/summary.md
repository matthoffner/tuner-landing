...
- Kind: `imported`
- Normalized counts: `428` properties, `428` permits, `868` inspections, `5` contractors, `3` rule documents, `1304` source records
- Fixture counts: `428` sequences, `5` pattern slices, `5` repeated slices, max permit support `416`
- Eval counts: `879` tasks, `434` reviewed label rows, `6` repeated next-action groups, `874` dev, `5` test
