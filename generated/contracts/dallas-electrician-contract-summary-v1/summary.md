...
- Kind: `imported`
- Normalized counts: `98` properties, `98` permits, `208` inspections, `5` contractors, `3` rule documents, `314` source records
- Fixture counts: `98` sequences, `5` pattern slices, `5` repeated slices, max permit support `86`
- Eval counts: `219` tasks, `104` reviewed label rows, `6` repeated next-action groups, `214` dev, `5` test
