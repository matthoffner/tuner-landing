...
- Kind: `imported`
- Normalized counts: `137` properties, `137` permits, `286` inspections, `5` contractors, `3` rule documents, `431` source records
- Fixture counts: `137` sequences, `5` pattern slices, `5` repeated slices, max permit support `125`
- Eval counts: `297` tasks, `143` reviewed label rows, `6` repeated next-action groups, `292` dev, `5` test
