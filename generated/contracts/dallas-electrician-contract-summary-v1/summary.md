...
- Kind: `imported`
- Normalized counts: `155` properties, `155` permits, `322` inspections, `5` contractors, `3` rule documents, `485` source records
- Fixture counts: `155` sequences, `5` pattern slices, `5` repeated slices, max permit support `143`
- Eval counts: `333` tasks, `161` reviewed label rows, `6` repeated next-action groups, `328` dev, `5` test
