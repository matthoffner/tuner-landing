...
- Kind: `imported`
- Normalized counts: `249` properties, `249` permits, `510` inspections, `5` contractors, `3` rule documents, `767` source records
- Fixture counts: `249` sequences, `5` pattern slices, `5` repeated slices, max permit support `237`
- Eval counts: `521` tasks, `255` reviewed label rows, `6` repeated next-action groups, `516` dev, `5` test
