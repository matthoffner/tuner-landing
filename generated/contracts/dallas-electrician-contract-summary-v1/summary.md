...
- Kind: `imported`
- Normalized counts: `345` properties, `345` permits, `702` inspections, `5` contractors, `3` rule documents, `1055` source records
- Fixture counts: `345` sequences, `5` pattern slices, `5` repeated slices, max permit support `333`
- Eval counts: `713` tasks, `351` reviewed label rows, `6` repeated next-action groups, `708` dev, `5` test
