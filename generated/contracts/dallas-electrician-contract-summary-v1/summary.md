...
- Kind: `imported`
- Normalized counts: `302` properties, `302` permits, `616` inspections, `5` contractors, `3` rule documents, `926` source records
- Fixture counts: `302` sequences, `5` pattern slices, `5` repeated slices, max permit support `290`
- Eval counts: `627` tasks, `308` reviewed label rows, `6` repeated next-action groups, `622` dev, `5` test
