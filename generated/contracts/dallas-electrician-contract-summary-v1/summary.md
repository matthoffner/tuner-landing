...
- Kind: `imported`
- Normalized counts: `485` properties, `485` permits, `982` inspections, `5` contractors, `3` rule documents, `1475` source records
- Fixture counts: `485` sequences, `5` pattern slices, `5` repeated slices, max permit support `473`
- Eval counts: `993` tasks, `491` reviewed label rows, `6` repeated next-action groups, `988` dev, `5` test
