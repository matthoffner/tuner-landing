...
- Kind: `imported`
- Normalized counts: `351` properties, `351` permits, `714` inspections, `5` contractors, `3` rule documents, `1073` source records
- Fixture counts: `351` sequences, `5` pattern slices, `5` repeated slices, max permit support `339`
- Eval counts: `725` tasks, `357` reviewed label rows, `6` repeated next-action groups, `720` dev, `5` test
