...
- Kind: `imported`
- Normalized counts: `75` properties, `75` permits, `162` inspections, `5` contractors, `3` rule documents, `245` source records
- Fixture counts: `75` sequences, `5` pattern slices, `5` repeated slices, max permit support `63`
- Eval counts: `173` tasks, `81` reviewed label rows, `6` repeated next-action groups, `168` dev, `5` test
