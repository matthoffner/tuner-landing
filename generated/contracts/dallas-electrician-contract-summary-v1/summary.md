...
- Kind: `imported`
- Normalized counts: `450` properties, `450` permits, `912` inspections, `5` contractors, `3` rule documents, `1370` source records
- Fixture counts: `450` sequences, `5` pattern slices, `5` repeated slices, max permit support `438`
- Eval counts: `923` tasks, `456` reviewed label rows, `6` repeated next-action groups, `918` dev, `5` test
