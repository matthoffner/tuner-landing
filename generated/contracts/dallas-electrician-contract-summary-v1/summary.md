...
- Kind: `imported`
- Normalized counts: `27` properties, `27` permits, `66` inspections, `5` contractors, `3` rule documents, `101` source records
- Fixture counts: `27` sequences, `5` pattern slices, `5` repeated slices, max permit support `15`
- Eval counts: `77` tasks, `33` reviewed label rows, `6` repeated next-action groups, `72` dev, `5` test
