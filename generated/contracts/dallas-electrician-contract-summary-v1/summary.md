...
- Kind: `imported`
- Normalized counts: `364` properties, `364` permits, `740` inspections, `5` contractors, `3` rule documents, `1112` source records
- Fixture counts: `364` sequences, `5` pattern slices, `5` repeated slices, max permit support `352`
- Eval counts: `751` tasks, `370` reviewed label rows, `6` repeated next-action groups, `746` dev, `5` test
