...
- Kind: `imported`
- Normalized counts: `161` properties, `161` permits, `334` inspections, `5` contractors, `3` rule documents, `503` source records
- Fixture counts: `161` sequences, `5` pattern slices, `5` repeated slices, max permit support `149`
- Eval counts: `345` tasks, `167` reviewed label rows, `6` repeated next-action groups, `340` dev, `5` test
