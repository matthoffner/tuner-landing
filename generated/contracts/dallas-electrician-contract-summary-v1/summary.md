...
- Kind: `imported`
- Normalized counts: `230` properties, `230` permits, `472` inspections, `5` contractors, `3` rule documents, `710` source records
- Fixture counts: `230` sequences, `5` pattern slices, `5` repeated slices, max permit support `218`
- Eval counts: `483` tasks, `236` reviewed label rows, `6` repeated next-action groups, `478` dev, `5` test
