...
- Kind: `imported`
- Normalized counts: `423` properties, `423` permits, `858` inspections, `5` contractors, `3` rule documents, `1289` source records
- Fixture counts: `423` sequences, `5` pattern slices, `5` repeated slices, max permit support `411`
- Eval counts: `869` tasks, `429` reviewed label rows, `6` repeated next-action groups, `864` dev, `5` test
