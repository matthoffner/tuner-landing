...
- Kind: `imported`
- Normalized counts: `354` properties, `354` permits, `720` inspections, `5` contractors, `3` rule documents, `1082` source records
- Fixture counts: `354` sequences, `5` pattern slices, `5` repeated slices, max permit support `342`
- Eval counts: `731` tasks, `360` reviewed label rows, `6` repeated next-action groups, `726` dev, `5` test
