...
- Kind: `imported`
- Normalized counts: `23` properties, `23` permits, `58` inspections, `5` contractors, `3` rule documents, `89` source records
- Fixture counts: `23` sequences, `5` pattern slices, `5` repeated slices, max permit support `11`
- Eval counts: `69` tasks, `29` reviewed label rows, `6` repeated next-action groups, `64` dev, `5` test
