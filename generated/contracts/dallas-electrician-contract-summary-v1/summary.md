...
- Kind: `imported`
- Normalized counts: `226` properties, `226` permits, `464` inspections, `5` contractors, `3` rule documents, `698` source records
- Fixture counts: `226` sequences, `5` pattern slices, `5` repeated slices, max permit support `214`
- Eval counts: `475` tasks, `232` reviewed label rows, `6` repeated next-action groups, `470` dev, `5` test
