...
- Kind: `imported`
- Normalized counts: `469` properties, `469` permits, `950` inspections, `5` contractors, `3` rule documents, `1427` source records
- Fixture counts: `469` sequences, `5` pattern slices, `5` repeated slices, max permit support `457`
- Eval counts: `961` tasks, `475` reviewed label rows, `6` repeated next-action groups, `956` dev, `5` test
