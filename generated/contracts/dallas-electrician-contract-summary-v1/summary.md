...
- Kind: `imported`
- Normalized counts: `50` properties, `50` permits, `112` inspections, `5` contractors, `3` rule documents, `170` source records
- Fixture counts: `50` sequences, `5` pattern slices, `5` repeated slices, max permit support `38`
- Eval counts: `123` tasks, `56` reviewed label rows, `6` repeated next-action groups, `118` dev, `5` test
