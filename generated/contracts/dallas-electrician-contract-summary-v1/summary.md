...
- Kind: `imported`
- Normalized counts: `156` properties, `156` permits, `324` inspections, `5` contractors, `3` rule documents, `488` source records
- Fixture counts: `156` sequences, `5` pattern slices, `5` repeated slices, max permit support `144`
- Eval counts: `335` tasks, `162` reviewed label rows, `6` repeated next-action groups, `330` dev, `5` test
