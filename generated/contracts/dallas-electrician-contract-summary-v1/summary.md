...
- Kind: `imported`
- Normalized counts: `113` properties, `113` permits, `238` inspections, `5` contractors, `3` rule documents, `359` source records
- Fixture counts: `113` sequences, `5` pattern slices, `5` repeated slices, max permit support `101`
- Eval counts: `249` tasks, `119` reviewed label rows, `6` repeated next-action groups, `244` dev, `5` test
