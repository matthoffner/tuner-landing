...
- Kind: `imported`
- Normalized counts: `74` properties, `74` permits, `160` inspections, `5` contractors, `3` rule documents, `242` source records
- Fixture counts: `74` sequences, `5` pattern slices, `5` repeated slices, max permit support `62`
- Eval counts: `171` tasks, `80` reviewed label rows, `6` repeated next-action groups, `166` dev, `5` test
