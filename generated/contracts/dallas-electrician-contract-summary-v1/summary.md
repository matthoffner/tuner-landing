...
- Kind: `imported`
- Normalized counts: `209` properties, `209` permits, `430` inspections, `5` contractors, `3` rule documents, `647` source records
- Fixture counts: `209` sequences, `5` pattern slices, `5` repeated slices, max permit support `197`
- Eval counts: `441` tasks, `215` reviewed label rows, `6` repeated next-action groups, `436` dev, `5` test
