...
- Kind: `imported`
- Normalized counts: `357` properties, `357` permits, `726` inspections, `5` contractors, `3` rule documents, `1091` source records
- Fixture counts: `357` sequences, `5` pattern slices, `5` repeated slices, max permit support `345`
- Eval counts: `737` tasks, `363` reviewed label rows, `6` repeated next-action groups, `732` dev, `5` test
