...
- Kind: `imported`
- Normalized counts: `31` properties, `31` permits, `74` inspections, `5` contractors, `3` rule documents, `113` source records
- Fixture counts: `31` sequences, `5` pattern slices, `5` repeated slices, max permit support `19`
- Eval counts: `85` tasks, `37` reviewed label rows, `6` repeated next-action groups, `80` dev, `5` test
