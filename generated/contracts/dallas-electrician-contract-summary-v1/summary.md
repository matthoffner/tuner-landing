...
- Kind: `imported`
- Normalized counts: `358` properties, `358` permits, `728` inspections, `5` contractors, `3` rule documents, `1094` source records
- Fixture counts: `358` sequences, `5` pattern slices, `5` repeated slices, max permit support `346`
- Eval counts: `739` tasks, `364` reviewed label rows, `6` repeated next-action groups, `734` dev, `5` test
