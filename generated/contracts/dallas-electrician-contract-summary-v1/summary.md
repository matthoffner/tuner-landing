...
- Kind: `imported`
- Normalized counts: `87` properties, `87` permits, `186` inspections, `5` contractors, `3` rule documents, `281` source records
- Fixture counts: `87` sequences, `5` pattern slices, `5` repeated slices, max permit support `75`
- Eval counts: `197` tasks, `93` reviewed label rows, `6` repeated next-action groups, `192` dev, `5` test
