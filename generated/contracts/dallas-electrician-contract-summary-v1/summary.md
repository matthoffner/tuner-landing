...
- Kind: `imported`
- Normalized counts: `515` properties, `515` permits, `1042` inspections, `5` contractors, `3` rule documents, `1565` source records
- Fixture counts: `515` sequences, `5` pattern slices, `5` repeated slices, max permit support `503`
- Eval counts: `1053` tasks, `521` reviewed label rows, `6` repeated next-action groups, `1048` dev, `5` test
