...
- Kind: `imported`
- Normalized counts: `278` properties, `278` permits, `568` inspections, `5` contractors, `3` rule documents, `854` source records
- Fixture counts: `278` sequences, `5` pattern slices, `5` repeated slices, max permit support `266`
- Eval counts: `579` tasks, `284` reviewed label rows, `6` repeated next-action groups, `574` dev, `5` test
