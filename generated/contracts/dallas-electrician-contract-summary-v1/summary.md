...
- Kind: `imported`
- Normalized counts: `147` properties, `147` permits, `306` inspections, `5` contractors, `3` rule documents, `461` source records
- Fixture counts: `147` sequences, `5` pattern slices, `5` repeated slices, max permit support `135`
- Eval counts: `317` tasks, `153` reviewed label rows, `6` repeated next-action groups, `312` dev, `5` test
