...
- Kind: `imported`
- Normalized counts: `478` properties, `478` permits, `968` inspections, `5` contractors, `3` rule documents, `1454` source records
- Fixture counts: `478` sequences, `5` pattern slices, `5` repeated slices, max permit support `466`
- Eval counts: `979` tasks, `484` reviewed label rows, `6` repeated next-action groups, `974` dev, `5` test
