...
- Kind: `imported`
- Normalized counts: `279` properties, `279` permits, `570` inspections, `5` contractors, `3` rule documents, `857` source records
- Fixture counts: `279` sequences, `5` pattern slices, `5` repeated slices, max permit support `267`
- Eval counts: `581` tasks, `285` reviewed label rows, `6` repeated next-action groups, `576` dev, `5` test
