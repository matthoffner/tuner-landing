...
- Kind: `imported`
- Normalized counts: `434` properties, `434` permits, `880` inspections, `5` contractors, `3` rule documents, `1322` source records
- Fixture counts: `434` sequences, `5` pattern slices, `5` repeated slices, max permit support `422`
- Eval counts: `891` tasks, `440` reviewed label rows, `6` repeated next-action groups, `886` dev, `5` test
