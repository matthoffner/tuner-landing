...
- Kind: `imported`
- Normalized counts: `245` properties, `245` permits, `502` inspections, `5` contractors, `3` rule documents, `755` source records
- Fixture counts: `245` sequences, `5` pattern slices, `5` repeated slices, max permit support `233`
- Eval counts: `513` tasks, `251` reviewed label rows, `6` repeated next-action groups, `508` dev, `5` test
