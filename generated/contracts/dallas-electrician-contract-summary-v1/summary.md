...
- Kind: `imported`
- Normalized counts: `378` properties, `378` permits, `768` inspections, `5` contractors, `3` rule documents, `1154` source records
- Fixture counts: `378` sequences, `5` pattern slices, `5` repeated slices, max permit support `366`
- Eval counts: `779` tasks, `384` reviewed label rows, `6` repeated next-action groups, `774` dev, `5` test
