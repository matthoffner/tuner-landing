...
- Kind: `imported`
- Normalized counts: `444` properties, `444` permits, `900` inspections, `5` contractors, `3` rule documents, `1352` source records
- Fixture counts: `444` sequences, `5` pattern slices, `5` repeated slices, max permit support `432`
- Eval counts: `911` tasks, `450` reviewed label rows, `6` repeated next-action groups, `906` dev, `5` test
