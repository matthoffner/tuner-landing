...
- Kind: `imported`
- Normalized counts: `130` properties, `130` permits, `272` inspections, `5` contractors, `3` rule documents, `410` source records
- Fixture counts: `130` sequences, `5` pattern slices, `5` repeated slices, max permit support `118`
- Eval counts: `283` tasks, `136` reviewed label rows, `6` repeated next-action groups, `278` dev, `5` test
