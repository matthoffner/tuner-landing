...
- Kind: `imported`
- Normalized counts: `81` properties, `81` permits, `174` inspections, `5` contractors, `3` rule documents, `263` source records
- Fixture counts: `81` sequences, `5` pattern slices, `5` repeated slices, max permit support `69`
- Eval counts: `185` tasks, `87` reviewed label rows, `6` repeated next-action groups, `180` dev, `5` test
