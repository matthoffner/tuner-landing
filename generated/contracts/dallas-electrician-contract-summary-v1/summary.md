...
- Kind: `imported`
- Normalized counts: `309` properties, `309` permits, `630` inspections, `5` contractors, `3` rule documents, `947` source records
- Fixture counts: `309` sequences, `5` pattern slices, `5` repeated slices, max permit support `297`
- Eval counts: `641` tasks, `315` reviewed label rows, `6` repeated next-action groups, `636` dev, `5` test
