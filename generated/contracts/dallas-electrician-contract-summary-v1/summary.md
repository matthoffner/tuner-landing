...
- Kind: `imported`
- Normalized counts: `482` properties, `482` permits, `976` inspections, `5` contractors, `3` rule documents, `1466` source records
- Fixture counts: `482` sequences, `5` pattern slices, `5` repeated slices, max permit support `470`
- Eval counts: `987` tasks, `488` reviewed label rows, `6` repeated next-action groups, `982` dev, `5` test
