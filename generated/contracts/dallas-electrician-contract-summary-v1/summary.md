...
- Kind: `imported`
- Normalized counts: `385` properties, `385` permits, `782` inspections, `5` contractors, `3` rule documents, `1175` source records
- Fixture counts: `385` sequences, `5` pattern slices, `5` repeated slices, max permit support `373`
- Eval counts: `793` tasks, `391` reviewed label rows, `6` repeated next-action groups, `788` dev, `5` test
