...
- Kind: `imported`
- Normalized counts: `495` properties, `495` permits, `1002` inspections, `5` contractors, `3` rule documents, `1505` source records
- Fixture counts: `495` sequences, `5` pattern slices, `5` repeated slices, max permit support `483`
- Eval counts: `1013` tasks, `501` reviewed label rows, `6` repeated next-action groups, `1008` dev, `5` test
