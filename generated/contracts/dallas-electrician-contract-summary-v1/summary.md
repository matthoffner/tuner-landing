...
- Kind: `imported`
- Normalized counts: `453` properties, `453` permits, `918` inspections, `5` contractors, `3` rule documents, `1379` source records
- Fixture counts: `453` sequences, `5` pattern slices, `5` repeated slices, max permit support `441`
- Eval counts: `929` tasks, `459` reviewed label rows, `6` repeated next-action groups, `924` dev, `5` test
