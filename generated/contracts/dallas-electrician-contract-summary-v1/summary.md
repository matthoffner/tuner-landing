...
- Kind: `imported`
- Normalized counts: `125` properties, `125` permits, `262` inspections, `5` contractors, `3` rule documents, `395` source records
- Fixture counts: `125` sequences, `5` pattern slices, `5` repeated slices, max permit support `113`
- Eval counts: `273` tasks, `131` reviewed label rows, `6` repeated next-action groups, `268` dev, `5` test
