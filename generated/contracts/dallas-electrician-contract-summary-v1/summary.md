...
- Kind: `imported`
- Normalized counts: `266` properties, `266` permits, `544` inspections, `5` contractors, `3` rule documents, `818` source records
- Fixture counts: `266` sequences, `5` pattern slices, `5` repeated slices, max permit support `254`
- Eval counts: `555` tasks, `272` reviewed label rows, `6` repeated next-action groups, `550` dev, `5` test
