...
- Kind: `imported`
- Normalized counts: `533` properties, `533` permits, `1078` inspections, `5` contractors, `3` rule documents, `1619` source records
- Fixture counts: `533` sequences, `5` pattern slices, `5` repeated slices, max permit support `521`
- Eval counts: `1089` tasks, `539` reviewed label rows, `6` repeated next-action groups, `1084` dev, `5` test
