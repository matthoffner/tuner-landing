...
- Kind: `imported`
- Normalized counts: `463` properties, `463` permits, `938` inspections, `5` contractors, `3` rule documents, `1409` source records
- Fixture counts: `463` sequences, `5` pattern slices, `5` repeated slices, max permit support `451`
- Eval counts: `949` tasks, `469` reviewed label rows, `6` repeated next-action groups, `944` dev, `5` test
