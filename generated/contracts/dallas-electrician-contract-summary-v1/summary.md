...
- Kind: `imported`
- Normalized counts: `37` properties, `37` permits, `86` inspections, `5` contractors, `3` rule documents, `131` source records
- Fixture counts: `37` sequences, `5` pattern slices, `5` repeated slices, max permit support `25`
- Eval counts: `97` tasks, `43` reviewed label rows, `6` repeated next-action groups, `92` dev, `5` test
