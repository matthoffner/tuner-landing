...
- Kind: `imported`
- Normalized counts: `427` properties, `427` permits, `866` inspections, `5` contractors, `3` rule documents, `1301` source records
- Fixture counts: `427` sequences, `5` pattern slices, `5` repeated slices, max permit support `415`
- Eval counts: `877` tasks, `433` reviewed label rows, `6` repeated next-action groups, `872` dev, `5` test
