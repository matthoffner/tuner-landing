...
- Kind: `imported`
- Normalized counts: `157` properties, `157` permits, `326` inspections, `5` contractors, `3` rule documents, `491` source records
- Fixture counts: `157` sequences, `5` pattern slices, `5` repeated slices, max permit support `145`
- Eval counts: `337` tasks, `163` reviewed label rows, `6` repeated next-action groups, `332` dev, `5` test
