...
- Kind: `imported`
- Normalized counts: `180` properties, `180` permits, `372` inspections, `5` contractors, `3` rule documents, `560` source records
- Fixture counts: `180` sequences, `5` pattern slices, `5` repeated slices, max permit support `168`
- Eval counts: `383` tasks, `186` reviewed label rows, `6` repeated next-action groups, `378` dev, `5` test
