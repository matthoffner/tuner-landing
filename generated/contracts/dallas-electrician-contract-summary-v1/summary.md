...
- Kind: `imported`
- Normalized counts: `298` properties, `298` permits, `608` inspections, `5` contractors, `3` rule documents, `914` source records
- Fixture counts: `298` sequences, `5` pattern slices, `5` repeated slices, max permit support `286`
- Eval counts: `619` tasks, `304` reviewed label rows, `6` repeated next-action groups, `614` dev, `5` test
