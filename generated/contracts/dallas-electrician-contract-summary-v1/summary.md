...
- Kind: `imported`
- Normalized counts: `446` properties, `446` permits, `904` inspections, `5` contractors, `3` rule documents, `1358` source records
- Fixture counts: `446` sequences, `5` pattern slices, `5` repeated slices, max permit support `434`
- Eval counts: `915` tasks, `452` reviewed label rows, `6` repeated next-action groups, `910` dev, `5` test
