...
- Kind: `imported`
- Normalized counts: `54` properties, `54` permits, `120` inspections, `5` contractors, `3` rule documents, `182` source records
- Fixture counts: `54` sequences, `5` pattern slices, `5` repeated slices, max permit support `42`
- Eval counts: `131` tasks, `60` reviewed label rows, `6` repeated next-action groups, `126` dev, `5` test
