...
- Queue items: `415`
- Priority counts: `{"high": 6, "medium": 409}`
- Trigger result counts: `{"fail": 6, "not_ready": 4, "partial": 405}`
- Operator correction events: `415`
...
- Trigger results: `{"partial": 390}`
- Failure reasons: `{"incomplete_work": 390}`
- Inspection types: `{"rough_in": 390}`
- Follow-up results: `{"pass": 390}`
