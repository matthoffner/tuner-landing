...
- Queue items: `429`
- Priority counts: `{"high": 6, "medium": 423}`
- Trigger result counts: `{"fail": 6, "not_ready": 4, "partial": 419}`
- Operator correction events: `429`
...
- Trigger results: `{"partial": 404}`
- Failure reasons: `{"incomplete_work": 404}`
- Inspection types: `{"rough_in": 404}`
- Follow-up results: `{"pass": 404}`
