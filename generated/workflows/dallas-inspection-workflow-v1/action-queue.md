...
- Queue items: `383`
- Priority counts: `{"high": 6, "medium": 377}`
- Trigger result counts: `{"fail": 6, "not_ready": 4, "partial": 373}`
- Operator correction events: `383`
...
- Trigger results: `{"partial": 358}`
- Failure reasons: `{"incomplete_work": 358}`
- Inspection types: `{"rough_in": 358}`
- Follow-up results: `{"pass": 358}`
