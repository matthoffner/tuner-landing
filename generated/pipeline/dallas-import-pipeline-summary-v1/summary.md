...
- Queue items: `303`
- Operator corrections: `303/303`
- Accepted patterns: `6`
- Import artifacts: `303` permits, `618` inspections, `629` eval tasks, `309` reviewed labels
...
- Next raw import row counts: `permits.csv`=304, `inspections.csv`=619, `contractors.csv`=6, `rule_documents.csv`=3
...
- Next raw import append rows: `permits.csv` row 306, `inspections.csv` row 621, `contractors.csv` row 8, `rule_documents.csv` row 5
...
- Normalized rows: `303` properties, `303` permits, `618` inspections, `5` contractors
- Source support: `929` source records, `3` rule documents
- Eval rows: `629` tasks, `309` reviewed labels, `624` dev tasks, `5` test tasks
- Task families: `315` next-outcome, `6` failure-reason, `303` next-action, `5` pattern-extraction
...
- Raw CSV row counts: `permits.csv`=304, `inspections.csv`=619, `contractors.csv`=6, `rule_documents.csv`=3
...
- `permits.csv` fingerprint: `sha256` `2023539320a7e6391bfc4f4825f7e8df15dba7f37b17ddcde98e2dd7bbe8dfca` (106435 bytes)
- `inspections.csv` fingerprint: `sha256` `c16b0ac71612fe09675b13bde3900cc0db73a57f473444ee9b3a32fc52965669` (153334 bytes)
...
- Raw CSV next append rows: `permits.csv` row 306, `inspections.csv` row 621, `contractors.csv` row 8, `rule_documents.csv` row 5
- Raw CSV last data rows:
- `permits.csv` last data row: `{"csv_row_number": 305, "row": {"permit_number": "ELZ-2026-0504", "address": "6172 S Ewing Ave", "city": "Dallas", "trade": "electrical", "work_class": "residential"}}`
- `inspections.csv` last data row: `{"csv_row_number": 620, "row": {"permit_number": "ELZ-2026-0504", "inspection_date": "2026-05-25", "inspection_type": "Correction follow-up", "result": "Pass"}}`
...
- `permits.csv` value profiles: `{"rows_checked": 304, "fields": {"city": {"distinct_value_count": 1, "blank_count": 0, "top_values": [{"value": "Dallas", "count": 304}]}, "trade": {"distinct_value_count": 2, "blank_count": 0, "top_values": [{"value": "electrical", "count": 303}, {"value": "plumbing", "count": 1}]}, "work_class": {"distinct_value_count": 1, "blank_count": 0, "top_values": [{"value": "residential", "count": 304}]}, "permit_type": {"distinct_value_count": 5, "blank_count": 0, "top_values": [{"value": "Electrical repair", "count": 292}, {"value": "Residential electrical remodel", "count": 5}, {"value": "Electrical service upgrade", "count": 4}, {"value": "New electrical install", "count": 2}, {"value": "Residential plumbing repair", "count": 1}]}, "status": {"distinct_value_count": 3, "blank_count": 0, "top_values": [{"value": "Finaled", "count": 299}, {"value": "Active", "count": 4}, {"value": "Issued", "count": 1}]}, "property_type": {"distinct_value_count": 2, "blank_count": 0, "top_values": [{"value": "single_family", "count": 302}, {"value": "duplex", "count": 2}]}, "zip_code": {"distinct_value_count": 5, "blank_count": 0, "top_values": [{"value": "75216", "count": 292}, {"value": "75228", "count": 4}, {"value": "75208", "count": 3}, {"value": "75212", "count": 3}, {"value": "75214", "count": 2}]}}}`
- `inspections.csv` value profiles: `{"rows_checked": 619, "fields": {"inspection_type": {"distinct_value_count": 4, "blank_count": 0, "top_values": [{"value": "Correction follow-up", "count": 303}, {"value": "Rough-in", "count": 301}, {"value": "Final", "count": 11}, {"value": "Service release", "count": 4}]}, "result": {"distinct_value_count": 6, "blank_count": 0, "top_values": [{"value": "Pass", "count": 312}, {"value": "Partial", "count": 293}, {"value": "Fail", "count": 6}, {"value": "Not Ready", "count": 4}, {"value": "Cancelled", "count": 2}, {"value": "Pending", "count": 2}]}, "reinspection_flag": {"distinct_value_count": 2, "blank_count": 0, "top_values": [{"value": "false", "count": 312}, {"value": "true", "count": 307}]}}}`
...
- `permits.csv` date profiles: `{"rows_checked": 304, "fields": {"file_date": {"field_present": true, "date_format": "YYYY-MM-DD", "blank_count": 0, "valid_date_count": 304, "invalid_date_count": 0, "earliest_date": "2026-03-12", "earliest_csv_row_number": 5, "latest_date": "2026-05-24", "latest_csv_row_number": 106, "invalid_examples": []}, "issue_date": {"field_present": true, "date_format": "YYYY-MM-DD", "blank_count": 0, "valid_date_count": 304, "invalid_date_count": 0, "earliest_date": "2026-03-13", "earliest_csv_row_number": 5, "latest_date": "2026-05-25", "latest_csv_row_number": 106, "invalid_examples": []}, "final_date": {"field_present": true, "date_format": "YYYY-MM-DD", "blank_count": 5, "valid_date_count": 299, "invalid_date_count": 0, "earliest_date": "2026-03-22", "earliest_csv_row_number": 5, "latest_date": "2026-05-25", "latest_csv_row_number": 106, "invalid_examples": []}}}`
- `inspections.csv` date profiles: `{"rows_checked": 619, "fields": {"inspection_date": {"field_present": true, "date_format": "YYYY-MM-DD", "blank_count": 0, "valid_date_count": 619, "invalid_date_count": 0, "earliest_date": "2026-03-17", "earliest_csv_row_number": 11, "latest_date": "2026-05-25", "latest_csv_row_number": 222, "invalid_examples": []}}}`
...
- `inspections_to_permits` relationship: `618/619` matched importable target rows, excluded target rows `1`, unresolved rows `0`, unmatched examples `[]`, excluded target examples `[{"csv_row_number": 42, "row": {"permit_number": "PLM-2026-0206", "inspection_date": "2026-04-11", "inspection_type": "Final", "result": "Pass"}}]`
- `permits_to_contractors` relationship: `303/304` matched importable target rows, excluded target rows `1`, unresolved rows `0`, unmatched examples `[]`, excluded target examples `[{"csv_row_number": 16, "row": {"permit_number": "PLM-2026-0206", "address": "410 W Jefferson Blvd", "city": "Dallas", "trade": "plumbing", "work_class": "residential"}}]`
- Raw CSV import scope counts:
- `permits.csv` import scope: `303/304` importable, excluded: `1`, reasons: `{"excluded_by_city": 0, "excluded_by_trade": 1, "excluded_by_work_class": 0}`
- `inspections.csv` import scope: `618/619` importable, excluded: `1`, reasons: `{"excluded_by_unimported_permit": 1}`
...
- `permits.csv` append work order: path `generated/raw/dallas-electrician-import-sample-v2/permits.csv`, row `306`, header `permit_number,address,city,state,zip_code,trade,work_class,property_type,permit_type,status,file_date,issue_date,final_date,declared_valuation,work_description,contractor_name,source_url`, template `<required>,<required>,<required>,,,<required>,<required>,,,,,,,,,,`
- `inspections.csv` append work order: path `generated/raw/dallas-electrician-import-sample-v2/inspections.csv`, row `621`, header `permit_number,inspection_date,inspection_type,result,notes,inspector_name,reinspection_flag,source_url`, template `<required>,<required>,<required>,<required>,,,,`
...
- `permits.csv` append sequence: path `generated/raw/dallas-electrician-import-sample-v2/permits.csv`, row `306`, header `permit_number,address,city,state,zip_code,trade,work_class,property_type,permit_type,status,file_date,issue_date,final_date,declared_valuation,work_description,contractor_name,source_url`, template `<required>,<required>,<required>,,,<required>,<required>,,,,,,,,,,`
- `inspections.csv` append sequence: path `generated/raw/dallas-electrician-import-sample-v2/inspections.csv`, row `621`, header `permit_number,inspection_date,inspection_type,result,notes,inspector_name,reinspection_flag,source_url`, template `<required>,<required>,<required>,<required>,,,,`
...
- `permits.csv` required-field gaps: `0/304` rows, missing headers: none, field counts: `{"address": 0, "city": 0, "permit_number": 0, "trade": 0, "work_class": 0}`
- `inspections.csv` required-field gaps: `0/619` rows, missing headers: none, field counts: `{"inspection_date": 0, "inspection_type": 0, "permit_number": 0, "result": 0}`
